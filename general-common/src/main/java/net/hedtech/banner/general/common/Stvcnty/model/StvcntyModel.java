...
public class StvcntyModel extends FormModel {
	
	
	public StvcntyModel(ITask task, Hashtable parameters){
	...
	public IDBBusinessObject getStvcnty() 
	{
		return (IDBBusinessObject) getBusinessObject("STVCNTY");
	}
