...
public class GNavBlockController extends DefaultBlockController {
	...
	//action methods generated from triggers
		...
		*/
		...
		/* Original PL/SQL code code for TRIGGER GO_ITEM.G$_SEARCH_OPTIONS
		 BEGIN
		...
		*/
		...
		public void goItem_GSearchOptions()
		{
				...
				if ( !getGlobal("MENU_NAME_PARM").isNull() )
				{
					...
					// F2J_NOT_SUPPORTED : Call to built-in "DO_KEY" was removed because it is not supported. See documentation for details "file://D:\Work\forms2net\Projects\Ellucian\Conversion\Docs\GUTPMNUF2NMigrationGuide.xml#DefaultExcludeBuiltin2".
					//					SupportClasses.SQLFORMS.DoKey("ENTER");
//					System.err.println("// F2J_NOT_SUPPORTED : Call to built-in 'DO_KEY' was removed because it is not supported. See documentation for details 'file://D:\\Work\\forms2net\\Projects\\Ellucian\\Conversion\\Docs\\GUTPMNUF2NMigrationGuide.xml#DefaultExcludeBuiltin2'.");
