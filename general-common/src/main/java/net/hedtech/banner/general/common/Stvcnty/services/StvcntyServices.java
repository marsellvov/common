package net.hedtech.banner.general.common.Stvcnty.services;
...
public class StvcntyServices extends AbstractSupportCodeObject{
	
	
	public StvcntyServices(ISupportCodeContainer container) {
		super(container);
	}
	
	public StvcntyTask  getTask() {
		return (StvcntyTask )super.getContainer();
	}

	
	public net.hedtech.banner.general.common.Stvcnty.model.StvcntyModel getFormModel() {
