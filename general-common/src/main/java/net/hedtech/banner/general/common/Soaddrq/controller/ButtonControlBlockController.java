	...
	//action methods generated from triggers
		...
		*/
		...
		/* Original PL/SQL code code for TRIGGER ID_LBT.WHEN-BUTTON-PRESSED
		 G$_KEY_OPT_MENU('KEY_BLOCK.ID', G$_NLS.Get('SOADDRQ-0007', 'FORM','Person Search') ,'LIST_VALUES',
                 G$_NLS.Get('SOADDRQ-0008', 'FORM','Non-Person Search') ,'COUNT_QUERY','','','','');
G$_CHECK_FAILURE;
:CHECK_KEYS := 'N';
		*/
		/*
		...
		*/
		...
		public void idLbt_buttonClick()
		{
				...
				getTask().getGoqrpls().gKeyOptMenu(toStr("KEY_BLOCK.ID"), GNls.Fget(toStr("SOADDRQ-0007"), toStr("FORM"), toStr("Person Search")), toStr("LIST_VALUES"), GNls.Fget(toStr("SOADDRQ-0008"), toStr("FORM"), toStr("Non-Person Search")), toStr("COUNT_QUERY"), toStr(""), toStr(""), toStr(""), toStr(""));
