package net.hedtech.banner.general.common.Stvdisa.services;
...
public class StvdisaServices extends AbstractSupportCodeObject{
	
	
	public StvdisaServices(ISupportCodeContainer container) {
		super(container);
	}
	
	public StvdisaTask  getTask() {
		return (StvdisaTask )super.getContainer();
	}

	
	public net.hedtech.banner.general.common.Stvdisa.model.StvdisaModel getFormModel() {
...
-- SOURCE  : enUS
-- TARGET  : I18N
-- DATE    : Wed Jan 20 15:04:07 2010
-- MSGSIGN : #83a7662981c1c554
BEGIN
  NULL;
