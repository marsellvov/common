...
import net.hedtech.banner.general.common.Stvnatn.controller.ButtonControlBlockController;
...
public class StvnatnModel extends FormModel {
	
	
	public StvnatnModel(ITask task, Hashtable parameters){
	...
	public IDBBusinessObject getStvnatn() 
	{
		return (IDBBusinessObject) getBusinessObject("STVNATN");
	}
