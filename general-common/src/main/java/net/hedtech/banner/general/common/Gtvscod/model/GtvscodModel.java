...
public class GtvscodModel extends FormModel {
	
	
	public GtvscodModel(ITask task, Hashtable parameters){
	...
	public IDBBusinessObject getGtvscod() 
	{
		return (IDBBusinessObject) getBusinessObject("GTVSCOD");
	}
