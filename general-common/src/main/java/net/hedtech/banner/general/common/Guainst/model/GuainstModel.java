...
public class GuainstModel extends FormModel {
	
	
	public GuainstModel(ITask task, Hashtable parameters){
	...
	public IDBBusinessObject getGubinst() 
	{
		return (IDBBusinessObject) getBusinessObject("GUBINST");
	}
