...
public class FormHeader extends SimpleBusinessObject
{
	...
	public NString getStvcollStatscanCode() {
		return toStr(super.getValue("STVCOLL_STATSCAN_CODE"));
	}
	
	public void setStvcollStatscanCode(NString value) {
		super.setValue("STVCOLL_STATSCAN_CODE", value);
	}
