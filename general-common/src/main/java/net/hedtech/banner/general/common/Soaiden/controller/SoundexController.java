	...
	//action methods generated from triggers
		...
		*/
		...
		/* Original PL/SQL code code for TRIGGER SOUNDEX.KEY-EXEQRY
		    PREVIOUS_BLOCK ;
   G$_CHECK_FAILURE ;
   IF (:SOUNDEX_LAST_NAME IS NULL AND
       :SOUNDEX_FIRST_NAME IS NULL ) THEN
      MESSAGE( G$_NLS.Get('SOAIDEN-0005', 'FORM','*ERROR* Define query criteria, then press EXECUTE QUERY.') );
   ...
   EXECUTE_TRIGGER('ENABLE_DETAIL_BTN_TRIG');
		...
		*/
		...
		public void soundex_ExecuteQuery()
		{
				...
				{
					errorMessage(GNls.Fget(toStr("SOAIDEN-0005"), toStr("FORM"), toStr("*ERROR* Define query criteria, then press EXECUTE QUERY.")));
