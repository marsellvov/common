...
public class GoamtchModel extends FormModel {
	
	
	public GoamtchModel(ITask task, Hashtable parameters){
	...
	public IDBBusinessObject getGotcmme() 
	{
		return (IDBBusinessObject) getBusinessObject("GOTCMME");
	}

	public IDBBusinessObject getGovcmrtMatch() 
	{
		return (IDBBusinessObject) getBusinessObject("GOVCMRT_MATCH");
	}

	public IDBBusinessObject getGovcmid() 
	{
		return (IDBBusinessObject) getBusinessObject("GOVCMID");
	}

	public Gorcmdo getGorcmdo() 
	{
		return (Gorcmdo) getBusinessObject("GORCMDO");
	}

	public IDBBusinessObject getGtvcmsc() 
	{
		return (IDBBusinessObject) getBusinessObject("GTVCMSC");
	}

	public IDBBusinessObject getGorcmsp() 
	{
		return (IDBBusinessObject) getBusinessObject("GORCMSP");
	}
