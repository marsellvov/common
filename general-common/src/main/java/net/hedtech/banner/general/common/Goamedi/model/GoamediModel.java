...
public class GoamediModel extends FormModel {
	
	
	public GoamediModel(ITask task, Hashtable parameters){
	...
	public IDBBusinessObject getSprmedi() 
	{
		return (IDBBusinessObject) getBusinessObject("SPRMEDI");
	}
