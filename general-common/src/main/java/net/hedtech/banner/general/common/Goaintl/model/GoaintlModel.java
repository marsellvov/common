...
public class GoaintlModel extends FormModel {
	
	
	public GoaintlModel(ITask task, Hashtable parameters){
	...
	public IDBBusinessObject getGorvisa() 
	{
		return (IDBBusinessObject) getBusinessObject("GORVISA");
	}

	public IDBBusinessObject getGordocm() 
	{
		return (IDBBusinessObject) getBusinessObject("GORDOCM");
	}

	public IDBBusinessObject getGobintl() 
	{
		return (IDBBusinessObject) getBusinessObject("GOBINTL");
	}
