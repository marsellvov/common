...
public class GuamesgModel extends FormModel {
	
	
	public GuamesgModel(ITask task, Hashtable parameters){
	...
	public IDBBusinessObject getGurtklr() 
	{
		return (IDBBusinessObject) getBusinessObject("GURTKLR");
	}
