...
public class GxadirdModel extends FormModel {
	
	
	public GxadirdModel(ITask task, Hashtable parameters){
	...
	public IDBBusinessObject getGxrdird() 
	{
		return (IDBBusinessObject) getBusinessObject("GXRDIRD");
	}
