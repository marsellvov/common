...
import net.hedtech.banner.general.common.Stvdegc.controller.ButtonControlBlockController;





public class StvdegcModel extends FormModel {
	
	
	public StvdegcModel(ITask task, Hashtable parameters){
	...
	public IDBBusinessObject getStvdegc() 
	{
		return (IDBBusinessObject) getBusinessObject("STVDEGC");
	}
