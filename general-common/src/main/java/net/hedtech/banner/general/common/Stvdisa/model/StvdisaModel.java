...
import net.hedtech.banner.general.common.Stvdisa.controller.ButtonControlBlockController;
...
public class StvdisaModel extends FormModel {
	
	
	public StvdisaModel(ITask task, Hashtable parameters){
	...
	public IDBBusinessObject getStvdisa() 
	{
		return (IDBBusinessObject) getBusinessObject("STVDISA");
	}
