...
public class RbTeachOrigination {
		public static NInteger fApiVersion() {
			
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("RB_TEACH_ORIGINATION.F_API_VERSION", DbManager.getDataBaseFactory());
		...
		public static NString fExists(NString pAidyCode,NNumber pPidm,NString pFundCode,NNumber pIntSeqNo,NString pRowid) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("RB_TEACH_ORIGINATION.F_EXISTS", DbManager.getDataBaseFactory());
		...
		public static NString fIsequal(TeachOriginationRecRow recOne,TeachOriginationRecRow recTwo) {
			
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("RB_TEACH_ORIGINATION.F_ISEQUAL", DbManager.getDataBaseFactory());
			
			cmd.addReturnParameter(NString.class);
			cmd.addParameter(DbTypes.createStructType("REC_ONE", recOne, TeachOriginationRecRow.class ));
			cmd.addParameter(DbTypes.createStructType("REC_TWO", recTwo, TeachOriginationRecRow.class ));
		...
		public static DataCursor fQueryAll(NString pAidyCode,NNumber pPidm,NString pFundCode,NNumber pIntSeqNo) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("RB_TEACH_ORIGINATION.F_QUERY_ALL", DbManager.getDataBaseFactory());
		...
		public static DataCursor fQueryByRowid(NString pRowid) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("RB_TEACH_ORIGINATION.F_QUERY_BY_ROWID", DbManager.getDataBaseFactory());
		...
		public static DataCursor fQueryOne(NString pAidyCode,NNumber pPidm,NString pFundCode,NNumber pIntSeqNo) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("RB_TEACH_ORIGINATION.F_QUERY_ONE", DbManager.getDataBaseFactory());
		...
		public static DataCursor fQueryOneLock(NString pAidyCode,NNumber pPidm,NString pFundCode,NNumber pIntSeqNo,NString pRowid) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("RB_TEACH_ORIGINATION.F_QUERY_ONE_LOCK", DbManager.getDataBaseFactory());
		...
		public static void pDelete(NString pAidyCode,NNumber pPidm,NString pFundCode,NNumber pIntSeqNo,NString pRowid) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("RB_TEACH_ORIGINATION.P_DELETE", DbManager.getDataBaseFactory());
		...
		public static void pLock(NString pAidyCode,NNumber pPidm,NString pFundCode,NNumber pIntSeqNo,Ref<NString> pRowidInout) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("RB_TEACH_ORIGINATION.P_LOCK", DbManager.getDataBaseFactory());
		...
		public static void pUpdate(NString pAidyCode,NNumber pPidm,NString pFundCode,NNumber pIntSeqNo,NString pAwardId,NString pFedFundId,NString pGrantType,NString pCampOpeid,NString pCampOpeidBranch,NString pInstOpeid,NString pInstOpeidBranch,NString pYrInColl,NString pSarTranNo,NNumber pAwardAmount,NDate pEnrollmentDate,NString pLockInd,NString pConcurEnrollFlag,NString pStatusCde,NDate pDateSent,NString pDocumentId,NString pAttendingId,NString pReportingId,NString pSourceId,NString pTeachExpertInd,NNumber pYtdAmtPaid,NNumber pNegPendingAmt,NNumber pPercentEligUsed,NNumber pAcptIntSeqNo,NString pAcptYrInColl,NString pAcptSarTranNo,NDate pAcptEnrollmentDate,NNumber pAcptAwardAmount,NString pAcptTeachExpertInd,NString pEditRej1,NString pEditRej2,NString pEditRej3,NString pEditRej4,NString pEditRej5,NString pEditField1,NString pEditField2,NString pEditField3,NString pEditField4,NString pEditField5,NString pEditValue1,NString pEditValue2,NString pEditValue3,NString pEditValue4,NString pEditValue5,NNumber pBookAmt,NDate pBookDate,NString pBookDocumentId,NString pUserId,NString pDataOrigin,NString pRowid) {
			
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("RB_TEACH_ORIGINATION.P_UPDATE", DbManager.getDataBaseFactory());
	...
	@DbRecordType(id="TeachOriginationRecRow", dataSourceName="TEACH_ORIGINATION_REC")
	public static class TeachOriginationRecRow
	{
		...
		@DbRecordField(dataSourceName="R_ACPT_TEACH_EXPERT_IND")
		public NString RAcptTeachExpertInd;
