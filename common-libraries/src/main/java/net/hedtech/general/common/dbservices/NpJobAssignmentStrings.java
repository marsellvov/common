...
public class NpJobAssignmentStrings {
		public static NString fGetError(NString pErrorname,NString pValue01,NString pValue02,NString pValue03) {
			
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("NP_JOB_ASSIGNMENT_STRINGS.F_GET_ERROR", DbManager.getDataBaseFactory());
