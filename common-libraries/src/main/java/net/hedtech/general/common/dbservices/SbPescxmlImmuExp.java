...
public class SbPescxmlImmuExp {
		public static void pImmuElement(NNumber pRequestPidmIn,Ref<DataCursor> pImmunizationRefcsrOut,Ref<NString> pHealthNoteOut) {
			
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("SB_PESCXML_IMMU_EXP.P_IMMU_ELEMENT", DbManager.getDataBaseFactory());
