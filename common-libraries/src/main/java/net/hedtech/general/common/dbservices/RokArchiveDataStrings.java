...
public class RokArchiveDataStrings {
		public static NString fGetError(NString pErrorname) {
			
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("ROK_ARCHIVE_DATA_STRINGS.F_GET_ERROR", DbManager.getDataBaseFactory());
		...
		public static NString fGetErrorWithValue(NString pPackage,NString pErrorname,NString pValue01,NString pValue02,NString pValue03) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("ROK_ARCHIVE_DATA_STRINGS.F_GET_ERROR_WITH_VALUE", DbManager.getDataBaseFactory());
