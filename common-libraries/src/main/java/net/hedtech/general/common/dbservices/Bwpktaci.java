...
//			
//			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("BWPKTACI.P_COPY", DbManager.getDataBaseFactory());
//			
...
//		
		public static void pDeletedrivertimeinout(NString jobsseqno,NString lastdate,NString parRestart,NString parUpdate,NString parSubmit,NString parRecall,NString earncode,NString dateselected,NString linenumber) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("BWPKTACI.P_DELETEDRIVERTIMEINOUT", DbManager.getDataBaseFactory());
		...
		public static void pDeletefortimeinout(NNumber jobsseqno,NString earncode,NDate parDate,NString parJlbdInd,NBool parPertitoExist) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("BWPKTACI.P_DELETEFORTIMEINOUT", DbManager.getDataBaseFactory());
		...
		public static void pDeletetimeinout(NString jobsseqno,NString lastdate,NString parRestart,NString parUpdate,NString parSubmit,NString parRecall,NString earncode,NString dateselected,NString linenumber) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("BWPKTACI.P_DELETETIMEINOUT", DbManager.getDataBaseFactory());
...
//			
//			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("BWPKTACI.P_TIMEINOUT", DbManager.getDataBaseFactory());
//			
//			cmd.addParameter("@JOBSSEQNO", jobsseqno);
//			cmd.addParameter("@LASTDATE", lastdate);
//			cmd.addParameter("@EARNCODE", earncode);
...
//			
//			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("BWPKTACI.P_UPDATECOPY", DbManager.getDataBaseFactory());
//			
//			cmd.addParameter("@JOBSSEQNO", jobsseqno);
//			cmd.addParameter("@LASTDATE", lastdate);
//			cmd.addParameter("@PAR_RESTART", parRestart);
...
//			
//			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("BWPKTACI.P_UPDATETIMEINOUT", DbManager.getDataBaseFactory());
//			
//			cmd.addParameter("@JOBSSEQNO", jobsseqno);
//			cmd.addParameter("@LASTDATE", lastdate);
//			cmd.addParameter("@PAR_RESTART", parRestart);
