...
public class SbPescxmlStudentUdeExp {
		public static void pStudentUdeElement(NNumber pRequestPidmIn,NNumber pRequestSeqNoIn,NString pRequestUserIn,NString pRequestTermIn,NString pRequestLevlIn,NString pRequestSbgiCodeIn,NString pRequesttableIn,Ref<NString> pParentElementNameOut,Ref<NString> pStudentUdeUriOut,Ref<NString> pParentValueOut) {
			
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("SB_PESCXML_STUDENT_UDE_EXP.P_STUDENT_UDE_ELEMENT", DbManager.getDataBaseFactory());
			...
			cmd.addParameter("@P_STUDENT_UDE_URI_OUT", NString.class);
			...
			pStudentUdeUriOut.val = cmd.getParameterValue("@P_STUDENT_UDE_URI_OUT", NString.class);
