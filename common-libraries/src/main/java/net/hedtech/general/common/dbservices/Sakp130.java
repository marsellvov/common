...
public class Sakp130 {
		public static void pP130Proc(NNumber aidm,NNumber applSeqno,NNumber hschSeqno,NString wappCode,NString procLabel,Ref<NString> errorInd) {
			
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("SAKP130.P_P130_PROC", DbManager.getDataBaseFactory());
