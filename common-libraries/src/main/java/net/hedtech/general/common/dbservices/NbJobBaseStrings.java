...
public class NbJobBaseStrings {
		public static NString fGetError(NString pErrorname,NString pValue01,NString pValue02,NString pValue03) {
			
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("NB_JOB_BASE_STRINGS.F_GET_ERROR", DbManager.getDataBaseFactory());
