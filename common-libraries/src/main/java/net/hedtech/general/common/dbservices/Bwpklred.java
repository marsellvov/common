...
public class Bwpklred {
		public static void pApproverdriver(NString jobsseqno,NString taYear,NString pictCode,NString payno,NString orgnCode,NString sortby,NString action,NString coasCode) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("BWPKLRED.P_APPROVERDRIVER", DbManager.getDataBaseFactory());
		...
		public static void pApproverextract(NString id,NString posn,NString suff,NString taYear,NString pictCode,NNumber payno,NString orgnCode,NString action,NString coasCode) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("BWPKLRED.P_APPROVEREXTRACT", DbManager.getDataBaseFactory());
...
//		public static void pApproversummary(NString taYear,NString pictCode,NNumber payno,NString action,NString apprAll,NString orgnCode,NString coasCode,List<Twbklibs.Varchar2TabtypeRow> appr,List<Twbklibs.Varchar2TabtypeRow> rcor) {
//			
//			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("BWPKLRED.P_APPROVERSUMMARY", DbManager.getDataBaseFactory());
//			
//			cmd.addParameter("@TA_YEAR", taYear);
//			cmd.addParameter("@PICT_CODE", pictCode);
//			cmd.addParameter("@PAYNO", payno);
...
//		}
		...
		public static void pDispfilter() {
			
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("BWPKLRED.P_DISPFILTER", DbManager.getDataBaseFactory());
		...
		public static void pDisplayapproverselection() {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("BWPKLRED.P_DISPLAYAPPROVERSELECTION", DbManager.getDataBaseFactory());
		...
		public static void pDisplayproxysetup() {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("BWPKLRED.P_DISPLAYPROXYSETUP", DbManager.getDataBaseFactory());
...
//			
//			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("BWPKLRED.P_DISPLAYSUPERUSERSELECTION", DbManager.getDataBaseFactory());
//			
...
//		}
		...
		public static void pProcdeleteappr(NString jobsseqno,NString buttonselected,NString taYear,NString pictCode,NString payno,NString sortby,NString action,NString orgnCode,NString coasCode) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("BWPKLRED.P_PROCDELETEAPPR", DbManager.getDataBaseFactory());
...
//			
//			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("BWPKLRED.P_PROCPROXYSETUP", DbManager.getDataBaseFactory());
//			
...
//		}
//		
//		public static void pProcselectapproveraction(NString sortby,List<Twbklibs.Varchar2TabtypeRow> payperiod,NString orgn) {
//			
//			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("BWPKLRED.P_PROCSELECTAPPROVERACTION", DbManager.getDataBaseFactory());
//			
//			cmd.addParameter("@SORTBY", sortby);
...
//		}
		...
		public static void pProcselectleavereportroll(NString action,NString proxyfor,NString superuser,NString scriptDis) {
			
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("BWPKLRED.P_PROCSELECTLEAVEREPORTROLL", DbManager.getDataBaseFactory());
		...
		public static void pProcselectleaverequestroll(NString action,NString proxyfor,NString superuser,NString scriptDis) {
			
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("BWPKLRED.P_PROCSELECTLEAVEREQUESTROLL", DbManager.getDataBaseFactory());
		...
		public static void pProcselectsuperuseraction(NString actionselected,NString coasselected,NString orgnselected,NString yearselected,NString pictselected,NString paynoselected,NString sortby) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("BWPKLRED.P_PROCSELECTSUPERUSERACTION", DbManager.getDataBaseFactory());
		...
		public static void pProcselecttimesheetroll(NString action,NString proxyfor,NString superuser,NString scriptDis) {
			
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("BWPKLRED.P_PROCSELECTTIMESHEETROLL", DbManager.getDataBaseFactory());
		...
		public static void pSelectleavereportroll() {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("BWPKLRED.P_SELECTLEAVEREPORTROLL", DbManager.getDataBaseFactory());
		...
		public static void pSelectleaverequestroll() {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("BWPKLRED.P_SELECTLEAVEREQUESTROLL", DbManager.getDataBaseFactory());
		...
		public static void pSelecttimesheetroll() {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("BWPKLRED.P_SELECTTIMESHEETROLL", DbManager.getDataBaseFactory());
...
//		public static void pUpdatetransactionstatus(NString taYear,NString pictCode,NString payno,NString action,NString apprAll,NString buttonselected,NString orgnCode,NString coasCode,List<Twbklibs.Varchar2TabtypeRow> appr,List<Twbklibs.Varchar2TabtypeRow> rcor) {
//			
//			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("BWPKLRED.P_UPDATETRANSACTIONSTATUS", DbManager.getDataBaseFactory());
//			
//			cmd.addParameter("@TA_YEAR", taYear);
//			cmd.addParameter("@PICT_CODE", pictCode);
//			cmd.addParameter("@PAYNO", payno);
...
//		}
		...
		public static void pValidateleavbalace(NString parJobsseqno,Ref<NString> parMsg) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("BWPKLRED.P_VALIDATELEAVBALACE", DbManager.getDataBaseFactory());
...
//			
//			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("BWPKLRED.P_VALIDATEMORELEAVREPTEXIST", DbManager.getDataBaseFactory());
//			
//			cmd.addParameter("@PAR_JOBSSEQNO", parJobsseqno);
...
//			
//			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("BWPKLRED.P_WRAPSELECTAPPROVERACTION", DbManager.getDataBaseFactory());
//			
