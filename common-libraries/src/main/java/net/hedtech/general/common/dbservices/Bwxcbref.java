...
public class Bwxcbref {
		public static NString fGetClassDesc(NNumber pPidm,NString pLevel,NString pTerm) {
			
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("BWXCBREF.F_GET_CLASS_DESC", DbManager.getDataBaseFactory());
		...
		public static void pGetStudentAdvisors(NNumber pPidm,NString pTerm,Ref<DataCursor> pStudentAdvisorsRef) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("BWXCBREF.P_GET_STUDENT_ADVISORS", DbManager.getDataBaseFactory());
		...
		public static void pGetStudentCurriculum(NNumber pPidm,NString pTerm,Ref<DataCursor> pStudentCurriculumRef) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("BWXCBREF.P_GET_STUDENT_CURRICULUM", DbManager.getDataBaseFactory());
		...
		public static void pGetViewTermSelect(Ref<DataCursor> pViewTermSelectRef) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("BWXCBREF.P_GET_VIEW_TERM_SELECT", DbManager.getDataBaseFactory());
