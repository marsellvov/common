...
public class Icsfksev {
		public static NBool fValidCpRegistration(NString rstsCodeIn,NString errorFlagIn) {
			
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("ICSFKSEV.F_VALID_CP_REGISTRATION", DbManager.getDataBaseFactory());
		...
		public static void pSendAddRegistration(NNumber pidmIn,NString crnIn,NString termCodeIn,NString rstsCodeIn,NString errorFlagIn,NString messageIn,NString oldRstsCodeIn,NString oldErrorFlagIn,NString oldMessageIn) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("ICSFKSEV.P_SEND_ADD_REGISTRATION", DbManager.getDataBaseFactory());
		...
		public static void pSendDropRegistration(NNumber pidmIn,NString crnIn,NString termCodeIn,NString rstsCodeIn,NString errorFlagIn,NString messageIn,NString newRstsCodeIn,NString newErrorFlagIn,NString newMessageIn) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("ICSFKSEV.P_SEND_DROP_REGISTRATION", DbManager.getDataBaseFactory());
