...
public class FvInvoiceAcctgRules {
		public static NString fGetCommitmentType(NString pPohdCode,NNumber pPoItem,NNumber pSeqNum) {
			
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("FV_INVOICE_ACCTG_RULES.F_GET_COMMITMENT_TYPE", DbManager.getDataBaseFactory());
		...
		public static NString fGetLiquidationType(NString pPohdCode,NString pPartPmtInd,NString pSingleAcctgInd) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("FV_INVOICE_ACCTG_RULES.F_GET_LIQUIDATION_TYPE", DbManager.getDataBaseFactory());
		...
		public static void pRegisterEntity(NNumber pOperationType,NString pInternalRecordId) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("FV_INVOICE_ACCTG_RULES.P_REGISTER_ENTITY", DbManager.getDataBaseFactory());
		...
		public static void pValidCreate(FvInvoiceAcctg.InvoiceAcctgRecRow pAcctgIn,Ref<FvInvoiceAcctg.InvoiceAcctgRecRow> pAcctgOut,Ref<NString> pErrorMsgOut) {
			
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("FV_INVOICE_ACCTG_RULES.P_VALID_CREATE", DbManager.getDataBaseFactory());
			
			cmd.addParameter(DbTypes.createStructType("P_ACCTG_IN", pAcctgIn, FvInvoiceAcctg.InvoiceAcctgRecRow.class ));
			cmd.addParameter(DbTypes.createStructType("P_ACCTG_OUT", FvInvoiceAcctg.InvoiceAcctgRecRow.class));
			cmd.addParameter("@P_ERROR_MSG_OUT", NString.class);
				
			cmd.execute();
			pAcctgOut.val = cmd.getParameterValue("@P_ACCTG_OUT", FvInvoiceAcctg.InvoiceAcctgRecRow.class);
		...
		public static void pValidDelete(NString pInvhCode,NNumber pItem,NNumber pSeqNum,NString pUserId,Ref<NString> pRowidInout,Ref<NString> pErrorMsgOut) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("FV_INVOICE_ACCTG_RULES.P_VALID_DELETE", DbManager.getDataBaseFactory());
		...
		public static void pValidUpdate(Ref<FvInvoiceAcctg.InvoiceAcctgRecRow> pAcctgRecInout,FvInvoiceAcctg.InvoiceAcctgRecRow pExistingRec,Ref<NString> pErrorMsgOut) {
			
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("FV_INVOICE_ACCTG_RULES.P_VALID_UPDATE", DbManager.getDataBaseFactory());
			
			cmd.addParameter(DbTypes.createStructType("P_ACCTG_REC_INOUT", pAcctgRecInout.val, FvInvoiceAcctg.InvoiceAcctgRecRow.class, true));
			cmd.addParameter(DbTypes.createStructType("P_EXISTING_REC", pExistingRec, FvInvoiceAcctg.InvoiceAcctgRecRow.class ));
			cmd.addParameter("@P_ERROR_MSG_OUT", NString.class);
				
			cmd.execute();
			pAcctgRecInout.val = cmd.getParameterValue("@P_ACCTG_REC_INOUT", FvInvoiceAcctg.InvoiceAcctgRecRow.class);
			pErrorMsgOut.val = cmd.getParameterValue("@P_ERROR_MSG_OUT", NString.class);
		...
		public static void pValidateMandatory(NString pInvhCode,NNumber pItem,NNumber pSeqNum,NString pUserId,NString pRuclCode,NString pSuspInd,NString pNsfSuspInd) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("FV_INVOICE_ACCTG_RULES.P_VALIDATE_MANDATORY", DbManager.getDataBaseFactory());
