...
public class FvReqTax {
		public static NInteger fApiVersion() {
			
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("FV_REQ_TAX.F_API_VERSION", DbManager.getDataBaseFactory());
		...
		public static NString fExists(NString pReqhCode,NNumber pItem,NNumber pPriorityNum,NString pTratCode,NString pRowid) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("FV_REQ_TAX.F_EXISTS", DbManager.getDataBaseFactory());
		...
		public static NString fIsequal(ReqTaxRecRow recOne,ReqTaxRecRow recTwo) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("FV_REQ_TAX.F_ISEQUAL", DbManager.getDataBaseFactory());
		...
		public static DataCursor fQueryAll() {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("FV_REQ_TAX.F_QUERY_ALL", DbManager.getDataBaseFactory());
		...
		public static DataCursor fQueryByItem(NString pReqhCode,NNumber pItem) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("FV_REQ_TAX.F_QUERY_BY_ITEM", DbManager.getDataBaseFactory());
		...
		public static DataCursor fQueryByRowid(NString pRowid) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("FV_REQ_TAX.F_QUERY_BY_ROWID", DbManager.getDataBaseFactory());
		...
		public static DataCursor fQueryOne(NString pReqhCode,NNumber pItem,NNumber pPriorityNum,NString pTratCode) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("FV_REQ_TAX.F_QUERY_ONE", DbManager.getDataBaseFactory());
		...
		public static DataCursor fQueryOneLock(NString pReqhCode,NNumber pItem,NNumber pPriorityNum,NString pTratCode,NString pRowid) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("FV_REQ_TAX.F_QUERY_ONE_LOCK", DbManager.getDataBaseFactory());
		...
		public static void pCalcAndCreate(NString pReqhCode,NNumber pItem,NString pTgrpCode,NDate pEffDate,NNumber pVendorPidm,NNumber pQuantity,NNumber pUnitPrice,NNumber pDiscAmt,NNumber pAddlAmt,NString pUserId,NString pDataOrigin,Ref<NNumber> pTaxAmtOut) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("FV_REQ_TAX.P_CALC_AND_CREATE", DbManager.getDataBaseFactory());
		...
		public static void pCreate(NString pReqhCode,NNumber pItem,NNumber pPriorityNum,NString pTratCode,NNumber pTaxAmt,NNumber pTaxableAmt,NString pPayTaxTo,NString pUserId,NString pDataOrigin,Ref<NString> pRowidOut) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("FV_REQ_TAX.P_CREATE", DbManager.getDataBaseFactory());
		...
		public static void pDelete(NString pReqhCode,NNumber pItem,NNumber pPriorityNum,NString pTratCode,NString pRowid) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("FV_REQ_TAX.P_DELETE", DbManager.getDataBaseFactory());
		...
		public static void pDeleteByItem(NString pReqhCode,NNumber pItem) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("FV_REQ_TAX.P_DELETE_BY_ITEM", DbManager.getDataBaseFactory());
		...
		public static void pLock(NString pReqhCode,NNumber pItem,NNumber pPriorityNum,NString pTratCode,Ref<NString> pRowidInout) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("FV_REQ_TAX.P_LOCK", DbManager.getDataBaseFactory());
		...
		public static void pUpdate(NString pReqhCode,NNumber pItem,NNumber pPriorityNum,NString pTratCode,NNumber pTaxAmt,NNumber pTaxableAmt,NString pPayTaxTo,NString pUserId,NString pDataOrigin,NString pRowid) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("FV_REQ_TAX.P_UPDATE", DbManager.getDataBaseFactory());
	...
	@DbRecordType(id="ReqTaxRecRow", dataSourceName="REQ_TAX_REC", needsInitialization=true)
