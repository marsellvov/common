...
public class Bwpktelc {
		public static void pComments(NString jobsseqno,NString lastdate,NString parRestart,NString parUpdate,NString parSubmit,NString parRecall,NString earncode,NString shift,NString specialrate,NString dateselected,NString hours,NString textin) {
			
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("BWPKTELC.P_COMMENTS", DbManager.getDataBaseFactory());
		...
		public static void pDeleteperelbd(NNumber parJobsSeqno,NString parEarnCode,NString parShift,NNumber parSpecialRate,NDate parTimeEntryDate) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("BWPKTELC.P_DELETEPERELBD", DbManager.getDataBaseFactory());
		...
		public static void pDisplayjlbd(NString jobsseqno,NString lastdate,NString parRestart,NString parUpdate,NString parSubmit,NString parRecall,NString earncode,NString shift,NString specialrate,NString dateselected,NString copytype,NString linenumber) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("BWPKTELC.P_DISPLAYJLBD", DbManager.getDataBaseFactory());
		...
		public static void pDispleavborrowed(NString jobsseqno,NString lastdate,NString parRestart,NString parUpdate,NString parSubmit,NString parRecall,NString earncode,NString shift,NString specialrate,NString dateselected) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("BWPKTELC.P_DISPLEAVBORROWED", DbManager.getDataBaseFactory());
		...
		public static void pInsertperelbd(NNumber parJobsSeqno,NString parEarnCode,NString parShift,NNumber parSpecialRate,NDate parTimeEntryDate,NNumber parSeqno,NString parCoasCode,NString parAcciCode,NString parFundCode,NString parOrgnCode,NString parAcctCode,NString parProgCode,NString parActvCode,NString parLocnCode,NString parProjCode,NString parCtypCode,NString parAcctCodeExternal,NNumber parHrs,NDate parActivityDate) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("BWPKTELC.P_INSERTPERELBD", DbManager.getDataBaseFactory());
...
//			
//			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("BWPKTELC.P_JLBD", DbManager.getDataBaseFactory());
//			
//			cmd.addParameter("@JOBSSEQNO", jobsseqno);
//			cmd.addParameter("@LASTDATE", lastdate);
//			cmd.addParameter("@PAR_RESTART", parRestart);
...
//		}
		...
		public static void pJlbdbuttonsdriver(NString jobsseqno,NString lastdate,NString parRestart,NString parUpdate,NString parSubmit,NString parRecall,NString earncode,NString shift,NString specialrate,NString dateselected,NString copytype,NString linenumber,NString buttonselected) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("BWPKTELC.P_JLBDBUTTONSDRIVER", DbManager.getDataBaseFactory());
		...
		public static void pUpdatecomments(NString jobsseqno,NString lastdate,NString parRestart,NString parUpdate,NString parSubmit,NString parRecall,NString buttonselected,NString earncode,NString shift,NString specialrate,NString dateselected,NString hours,NString textin) {
			
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("BWPKTELC.P_UPDATECOMMENTS", DbManager.getDataBaseFactory());
...
//			
//			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("BWPKTELC.P_UPDATENOFINJLBD", DbManager.getDataBaseFactory());
//			
//			cmd.addParameter("@JOBSSEQNO", jobsseqno);
//			cmd.addParameter("@LASTDATE", lastdate);
//			cmd.addParameter("@PAR_RESTART", parRestart);
