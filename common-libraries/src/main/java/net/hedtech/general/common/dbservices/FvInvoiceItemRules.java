...
public class FvInvoiceItemRules {
		public static NString fCheckTolerance(NString pUserId,FvInvoiceItem.InvoiceItemRecRow pItemRec) {
			
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("FV_INVOICE_ITEM_RULES.F_CHECK_TOLERANCE", DbManager.getDataBaseFactory());
			
			cmd.addReturnParameter(NString.class);
			cmd.addParameter("@P_USER_ID", pUserId);
			cmd.addParameter(DbTypes.createStructType("P_ITEM_REC", pItemRec, FvInvoiceItem.InvoiceItemRecRow.class ));
		...
		public static NString fGetAcceptAmt(NString pPohdCode,NNumber pPoItem) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("FV_INVOICE_ITEM_RULES.F_GET_ACCEPT_AMT", DbManager.getDataBaseFactory());
		...
		public static NString fGetAcceptQty(NString pPohdCode,NNumber pPoItem) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("FV_INVOICE_ITEM_RULES.F_GET_ACCEPT_QTY", DbManager.getDataBaseFactory());
		...
		public static NString fGetBoAmt(NString pInvhCode,NString pPohdCode,NNumber pPoItem) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("FV_INVOICE_ITEM_RULES.F_GET_BO_AMT", DbManager.getDataBaseFactory());
		...
		public static NString fGetDiscAmt(NString pDiscCode,NNumber pQty,NNumber pAmt,NDate pInvoiceDate) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("FV_INVOICE_ITEM_RULES.F_GET_DISC_AMT", DbManager.getDataBaseFactory());
		...
		public static NString fGetEncdAmt(NString pEncdNum) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("FV_INVOICE_ITEM_RULES.F_GET_ENCD_AMT", DbManager.getDataBaseFactory());
		...
		public static NString fGetLastRcvrInd(NString pPohdCode,NNumber pPoItem) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("FV_INVOICE_ITEM_RULES.F_GET_LAST_RCVR_IND", DbManager.getDataBaseFactory());
		...
		public static NString fGetOrderedAmt(NString pPohdCode,NNumber pPoItem) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("FV_INVOICE_ITEM_RULES.F_GET_ORDERED_AMT", DbManager.getDataBaseFactory());
		...
		public static NString fGetOrderedQty(NString pPohdCode,NNumber pPoItem) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("FV_INVOICE_ITEM_RULES.F_GET_ORDERED_QTY", DbManager.getDataBaseFactory());
		...
		public static NString fGetPrevAddlChrgAmt(NString pInvhCode,NString pPohdCode,NNumber pPoItem,NString pApprRequired) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("FV_INVOICE_ITEM_RULES.F_GET_PREV_ADDL_CHRG_AMT", DbManager.getDataBaseFactory());
		...
		public static NString fGetPrevPaidAmt(NString pInvhCode,NString pPohdCode,NNumber pPoItem,NString pApprRequired) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("FV_INVOICE_ITEM_RULES.F_GET_PREV_PAID_AMT", DbManager.getDataBaseFactory());
		...
		public static NString fGetPrevPaidQty(NString pInvhCode,NString pPohdCode,NNumber pPoItem,NString pApprRequired) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("FV_INVOICE_ITEM_RULES.F_GET_PREV_PAID_QTY", DbManager.getDataBaseFactory());
		...
		public static void pRegisterEntity(NNumber pOperationType,NString pInternalRecordId) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("FV_INVOICE_ITEM_RULES.P_REGISTER_ENTITY", DbManager.getDataBaseFactory());
		...
		public static void pValidDelete(NString pInvhCode,NNumber pItem,NString pUserId,Ref<NString> pRowidInout,Ref<NString> pErrorMessageOut) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("FV_INVOICE_ITEM_RULES.P_VALID_DELETE", DbManager.getDataBaseFactory());
		...
		public static void pValidUpdate(Ref<FvInvoiceItem.InvoiceItemRecRow> pItemRecInout,FvInvoiceItem.InvoiceItemRecRow pExistingRec,Ref<NString> pErrorMsgOut) {
			
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("FV_INVOICE_ITEM_RULES.P_VALID_UPDATE", DbManager.getDataBaseFactory());
			
			cmd.addParameter(DbTypes.createStructType("P_ITEM_REC_INOUT", pItemRecInout.val, FvInvoiceItem.InvoiceItemRecRow.class, true));
			cmd.addParameter(DbTypes.createStructType("P_EXISTING_REC", pExistingRec, FvInvoiceItem.InvoiceItemRecRow.class ));
			cmd.addParameter("@P_ERROR_MSG_OUT", NString.class);
				
			cmd.execute();
			pItemRecInout.val = cmd.getParameterValue("@P_ITEM_REC_INOUT", FvInvoiceItem.InvoiceItemRecRow.class);
			pErrorMsgOut.val = cmd.getParameterValue("@P_ERROR_MSG_OUT", NString.class);


		}
		
		public static void pValidate(Ref<FvInvoiceItem.InvoiceItemRecRow> pItemRecInout,FvInvoiceItem.InvoiceItemRecRow pExistingRec,NNumber pOperationType,Ref<NString> pErrorMsgOut) {
			
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("FV_INVOICE_ITEM_RULES.P_VALIDATE", DbManager.getDataBaseFactory());
		...
		public static void pValidateMandatory(FvInvoiceItem.InvoiceItemRecRow pItemRec,Ref<NString> pErrorMsgInout) {
			
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("FV_INVOICE_ITEM_RULES.P_VALIDATE_MANDATORY", DbManager.getDataBaseFactory());
