...
public class TgkuUserVarDesc {
		public static NInteger fApiVersion() {
			
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("TGKU_USER_VAR_DESC.F_API_VERSION", DbManager.getDataBaseFactory());
		...
		public static DataCursor fQueryOneLock(NString pAidyCode,NString pRowid) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("TGKU_USER_VAR_DESC.F_QUERY_ONE_LOCK", DbManager.getDataBaseFactory());
...
//			
//			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("TGKU_USER_VAR_DESC.P_UPDATE", DbManager.getDataBaseFactory());
//			
//			cmd.addParameter("@P_AIDY_CODE", pAidyCode);
