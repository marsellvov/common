...
public class SbPescxmlMainUdeExp {
		public static void pMainUdeElement(NNumber pRequestPidmIn,NNumber pRequestSeqNoIn,NString pRequestUserIn,NString pRequestTermIn,NString pRequestLevlIn,NString pRequestSbgiCodeIn,NString pRequesttableIn,Ref<NString> pParentElementNameOut,Ref<NString> pMainUdeUriOut,Ref<NString> pParentValueOut) {
			
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("SB_PESCXML_MAIN_UDE_EXP.P_MAIN_UDE_ELEMENT", DbManager.getDataBaseFactory());
			...
			cmd.addParameter("@P_MAIN_UDE_URI_OUT", NString.class);
			...
			pMainUdeUriOut.val = cmd.getParameterValue("@P_MAIN_UDE_URI_OUT", NString.class);
