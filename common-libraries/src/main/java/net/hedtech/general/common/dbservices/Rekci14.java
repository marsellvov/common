...
public class Rekci14 {
		public static NString fGetVersion() {
			
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("REKCI14.F_GET_VERSION", DbManager.getDataBaseFactory());
		...
		public static void pUpdateCounselingAck(NString pAidyCode,NString pDocumentId,NString pDocumentTypeCode,NDate pProcessDate,NString pSsn,NDate pBirthDate,NString pLastName,NString pFirstName,NString pMiddleInit,NString pAwardYear,NString pCounselingType,NDate pCompDate,NNumber pSequenceNo,NString pEntrReq,NString pEntrReqStatus,NString pGplusEntrReq,NString pGplusEntrReqStatus,NString pCounselingRespCode,NString pDlEntrReq,NString pDlEntrReqStatus,NString pExitReq,NString pExitReqStatus) {
			
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("REKCI14.P_UPDATE_COUNSELING_ACK", DbManager.getDataBaseFactory());
			...
			cmd.addParameter("@P_DL_ENTR_REQ", pDlEntrReq);
			cmd.addParameter("@P_DL_ENTR_REQ_STATUS", pDlEntrReqStatus);
			cmd.addParameter("@P_EXIT_REQ", pExitReq);
			cmd.addParameter("@P_EXIT_REQ_STATUS", pExitReqStatus);
...
//			
//			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("REKCI14.P_UPDATE_DLPLUS_DISBURSEMENTS", DbManager.getDataBaseFactory());
//			
//			cmd.addParameter("@P_AIDY_CODE", pAidyCode);
//			cmd.addParameter("@P_DOCUMENT_ID", pDocumentId);
//			cmd.addParameter("@P_DOCUMENT_TYPE_CODE", pDocumentTypeCode);
...
//			cmd.addParameter("@P_PAR_ADDR_LINE2", pParAddrLine2);
//			cmd.addParameter("@P_PAR_ADDR_LINE3", pParAddrLine3);
//			cmd.addParameter("@P_PAR_LOCAL_ADDR_LINE2", pParLocalAddrLine2);
//			cmd.addParameter("@P_PAR_LOCAL_ADDR_LINE3", pParLocalAddrLine3);
//			cmd.addParameter("@P_ACPT_STATUS", pAcptStatus);
...
//			cmd.addParameter("@P_PAR_IN_DEFAULT", pParInDefault);
...
//			
//			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("REKCI14.P_UPDATE_DLSUB_DISBURSEMENTS", DbManager.getDataBaseFactory());
//			
//			cmd.addParameter("@P_AIDY_CODE", pAidyCode);
//			cmd.addParameter("@P_DOCUMENT_ID", pDocumentId);
//			cmd.addParameter("@P_DOCUMENT_TYPE_CODE", pDocumentTypeCode);
...
//			cmd.addParameter("@P_MPN_LINK_IND", pMpnLinkInd);
//			cmd.addParameter("@P_ACPT_STATUS", pAcptStatus);
//			cmd.addParameter("@P_ENTRANCE_COUNSELING", pEntranceCounseling);
//			cmd.addParameter("@P_DL_ENTR_REQ", pDlEntrReq);
//			cmd.addParameter("@P_DL_ENTR_REQ_STATUS", pDlEntrReqStatus);
//				
//			cmd.execute();
...
//			
//			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("REKCI14.P_UPDATE_DLUNSUB_DISBURSEMENTS", DbManager.getDataBaseFactory());
//			
//			cmd.addParameter("@P_AIDY_CODE", pAidyCode);
//			cmd.addParameter("@P_DOCUMENT_ID", pDocumentId);
//			cmd.addParameter("@P_DOCUMENT_TYPE_CODE", pDocumentTypeCode);
...
//			
//			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("REKCI14.P_UPDATE_DLUNSUB_ORIGINATIONS", DbManager.getDataBaseFactory());
//			
//			cmd.addParameter("@P_AIDY_CODE", pAidyCode);
//			cmd.addParameter("@P_DOCUMENT_ID", pDocumentId);
//			cmd.addParameter("@P_SSN", pSsn);
...
//			
//			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("REKCI14.P_UPDATE_GPLUS_DISBURSEMENTS", DbManager.getDataBaseFactory());
//			
//			cmd.addParameter("@P_AIDY_CODE", pAidyCode);
//			cmd.addParameter("@P_DOCUMENT_ID", pDocumentId);
//			cmd.addParameter("@P_DOCUMENT_TYPE_CODE", pDocumentTypeCode);
...
//		}
//		
//		public static void pUpdateGplusOriginations(NString pAidyCode,NString pDocumentId,NString pSsn,NString pLastName,NDate pBirthDate,NString pStudentStatusCde,List<StringNtRow> pRejectCodes,NString pDlLoanId,NNumber pApproveAmt,NString pEmpnIndicator,NString pDlStatus,NString pMpnId,NDate pMpnExpDate,NString pMpnStatusInd,NNumber pParEndorserAmt,List<StringNtRow> pDlRejectCodes,NString pDocumentTypeCode,NDate pConfDate,List<StringNtRow> pResponseErrorField,List<StringNtRow> pLogRejectCode,NString pCreditStatus,NDate pCreditCheckDate,NString pCreditCheckInd,NDate pBookDate,NNumber pLocTotNetLoanAmt,List<StringNtRow> pDlErrorFields,List<StringNtRow> pRejectFields,NString pAppId,NString pMaxLoanInd,NDate pAppCompDate,NString pDefermentOpt,NString pPlusToStudent,NString pOrigCreditStatus,NDate pCreditCheckExpDate,NNumber pAppLoanAmt,NString pCrAppealStatus,NString pCrOverrideCde,NString pAddress,NString pCity,NString pState,NString pZip,NString pNatnCode,NString pPhoneNo,NString pStuEmail,NString pLocalAddress,NString pLocalCity,NString pLocalStatCode,NString pLocalZip,NString pLocalNatnCode,NString pParSsn,NDate pParBirthDate,NString pParLastName,NString pParFirstName,NString pParMi,NString pParCitzInd,NString pParAddress,NString pParCity,NString pParState,NString pParZip,NString pParNatnCode,NString pParPhoneNo,NString pBorrowerEmail,NString pParLocalAddress,NString pParLocalCity,NString pParLocalStatCode,NString pParLocalZip,NString pParLocalNatnCode,NString pCreditDocumentId,NString pCrActionOpt,NString pFirstName,NString pMi,NString pUnsatPnStatus,NString pGplusReq,NString pGplusReqStatus,NString pMpnLinkInd,NString pAddrLine2,NString pAddrLine3,NString pLocalAddrLine2,NString pLocalAddrLine3,NString pParAddrLine2,NString pParAddrLine3,NString pParLocalAddrLine2,NString pParLocalAddrLine3,NString pAcptStatus,NString pPlusAppReason,NString pUnknownLoanAmtInd,NString pPreviousAppId,NDate pReqAwardStartDate,NDate pReqAwardEndDate,NString pEntranceCounseling,NString pSchoolCrBalanceOpt) {
//			
//			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("REKCI14.P_UPDATE_GPLUS_ORIGINATIONS", DbManager.getDataBaseFactory());
//			
//			cmd.addParameter("@P_AIDY_CODE", pAidyCode);
//			cmd.addParameter("@P_DOCUMENT_ID", pDocumentId);
//			cmd.addParameter("@P_SSN", pSsn);
...
//		}
		...
		public static void pUpdateIdStudent(NString pAidyCode,NString pDocumentId,NString pSsn,NString pLastName,NDate pBirthDate,NString pDocumentTypeCode,NDate pProcessDate) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("REKCI14.P_UPDATE_ID_STUDENT", DbManager.getDataBaseFactory());
...
//			
//			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("REKCI14.P_UPDATE_PELL_DISBURSEMENTS", DbManager.getDataBaseFactory());
//			
//			cmd.addParameter("@P_AIDY_CODE", pAidyCode);
//			cmd.addParameter("@P_DOCUMENT_ID", pDocumentId);
//			cmd.addParameter("@P_SSN", pSsn);
...
//			
//			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("REKCI14.P_UPDATE_PELL_ORIGINATIONS", DbManager.getDataBaseFactory());
//			
//			cmd.addParameter("@P_AIDY_CODE", pAidyCode);
//			cmd.addParameter("@P_DOCUMENT_ID", pDocumentId);
//			cmd.addParameter("@P_SSN", pSsn);
...
//		}
		...
		public static void pUpdateRercoddReceipt(NString pAidyCode,NString pDocumentId,NDate pCreatedDateTime,NString pDocumentStatusCode,NString pDocumentType) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("REKCI14.P_UPDATE_RERCODD_RECEIPT", DbManager.getDataBaseFactory());
...
//			
//			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("REKCI14.P_UPDATE_RERCODD_RESPONSE", DbManager.getDataBaseFactory());
//			
//			cmd.addParameter("@P_AIDY_CODE", pAidyCode);
//			cmd.addParameter("@P_DOCUMENT_ID", pDocumentId);
...
//			
//			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("REKCI14.P_UPDATE_TEACH_DISBURSEMENTS", DbManager.getDataBaseFactory());
//			
//			cmd.addParameter("@P_AIDY_CODE", pAidyCode);
//			cmd.addParameter("@P_DOCUMENT_ID", pDocumentId);
//			cmd.addParameter("@P_SSN", pSsn);
...
//			
//			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("REKCI14.P_UPDATE_TEACH_ORIGINATIONS", DbManager.getDataBaseFactory());
//			
//			cmd.addParameter("@P_AIDY_CODE", pAidyCode);
//			cmd.addParameter("@P_DOCUMENT_ID", pDocumentId);
//			cmd.addParameter("@P_SSN", pSsn);
