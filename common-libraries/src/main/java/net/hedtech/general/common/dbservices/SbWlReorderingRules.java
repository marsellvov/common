...
public class SbWlReorderingRules {
		public static void pRegisterEntity(NNumber pOperationType,NString pInternalRecordId) {
			
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("SB_WL_REORDERING_RULES.P_REGISTER_ENTITY", DbManager.getDataBaseFactory());
		...
		public static void pRegisterEntity(NNumber pOperationType,NNumber pPrimaryKey,NString pTermCode,NNumber pPriorityNum,NString pUserId,NString pLevlCode,NString pCampCode,NString pCollCode,NString pDegcCode,NString pProgram,NString pClasCode,NString pAttsCode,NString pAstdCode,NString pChrtCode,NString pLfstCode,NString pMajrCode,NNumber pMinGpa,NNumber pMaxGpa,NString pDataOrigin,NString pInternalRecordId) {
		...
		public static void pValidate(NNumber pPrimaryKey,NString pTermCode,NNumber pPriorityNum,NString pUserId,NString pLevlCode,NString pCampCode,NString pCollCode,NString pDegcCode,NString pProgram,NString pClasCode,NString pAttsCode,NString pAstdCode,NString pChrtCode,NString pLfstCode,NString pMajrCode,NNumber pMinGpa,NNumber pMaxGpa,NString pDataOrigin) {
			
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("SB_WL_REORDERING_RULES.P_VALIDATE", DbManager.getDataBaseFactory());
