...
public class PbEmployeeRules {
		public static NString fMinimalAddrInfoExists(NNumber pPidm) {
			
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("PB_EMPLOYEE_RULES.F_MINIMAL_ADDR_INFO_EXISTS", DbManager.getDataBaseFactory());
		...
		public static NString fMinimalBioInfoExists(NNumber pPidm,Ref<NString> pErrorCode) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("PB_EMPLOYEE_RULES.F_MINIMAL_BIO_INFO_EXISTS", DbManager.getDataBaseFactory());
		...
		public static void pEditCoasCodeDist(NString pCoasCodeDist,Ref<NString> pErrorMsgOut) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("PB_EMPLOYEE_RULES.P_EDIT_COAS_CODE_DIST", DbManager.getDataBaseFactory());
		...
		public static void pEditCoasCodeHome(NString pCoasCodeHome,Ref<NString> pErrorMsgOut) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("PB_EMPLOYEE_RULES.P_EDIT_COAS_CODE_HOME", DbManager.getDataBaseFactory());
		...
		public static void pEditJobsStillOnLeave(NNumber pPidm,NDate pLoaEndDate,Ref<NString> pErrorMsgOut) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("PB_EMPLOYEE_RULES.P_EDIT_JOBS_STILL_ON_LEAVE", DbManager.getDataBaseFactory());
		...
		public static void pEditOrgnCodeDist(NString pCoasCodeDist,NString pOrgnCodeDist,Ref<NString> pErrorMsgOut) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("PB_EMPLOYEE_RULES.P_EDIT_ORGN_CODE_DIST", DbManager.getDataBaseFactory());
		...
		public static void pEditOrgnCodeHome(NString pCoasCodeHome,NString pOrgnCodeHome,Ref<NString> pErrorMsgOut) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("PB_EMPLOYEE_RULES.P_EDIT_ORGN_CODE_HOME", DbManager.getDataBaseFactory());
		...
		public static void pGetEclsDefaults(NString pEclsCode,Ref<NString> pLcatCodeOut,Ref<NString> pBcatCodeOut,Ref<NString> pStgrCodeOut,Ref<NString> pWkprCodeOut,Ref<NString> pFlsaIndOut,Ref<NString> pEgrpCodeOut,Ref<NString> pInternalFtPtIndOut) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("PB_EMPLOYEE_RULES.P_GET_ECLS_DEFAULTS", DbManager.getDataBaseFactory());
		...
		public static void pRegisterEntity(NNumber pOperationType,NString pInternalRecordId) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("PB_EMPLOYEE_RULES.P_REGISTER_ENTITY", DbManager.getDataBaseFactory());
		...
		public static void pValidate(Ref<PbEmployee.EmployeeRecRow> pValRecInout,NString pOperationType,NNumber pPidm,NString pEmplStatus,NString pCoasCodeHome,NString pOrgnCodeHome,NString pCoasCodeDist,NString pOrgnCodeDist,NString pEclsCode,NString pLcatCode,NString pBcatCode,NDate pFirstHireDate,NDate pCurrentHireDate,NDate pAdjServiceDate,NDate pSeniorityDate,NString pLreaCode,NDate pLoaBegDate,NDate pLoaEndDate,NString pTreaCode,NDate pTermDate,NString pI9FormInd,NDate pI9Date,NDate pI9ExpireDate,NString pWkprCode,NString pFlsaInd,NString pStgrCode,NNumber pDaysInCanada,NString p1042RecipientCd,NString pInternalFtPtInd,NString pDicdCode,NString pEgrpCode,NString pIpedsSoftMoneyInd,NDate pFirstWorkDate,NDate pLastWorkDate,NString pCalifPensionInd,NString pNrsiCode,NString pSsnLastName,NString pSsnFirstName,NString pSsnMi,NString pSsnSuffix,NString pJblnCode,NString pCollCode,NString pCampCode,NString pUserId,NString pDataOrigin,NString pEw2ConsentInd,NDate pEw2ConsentDate,NString pEw2ConsentUserId,NString pIpedsPrimaryFunction,NString pIpedsMedDentalInd,NString pEtaxConsentInd,NDate pEtaxConsentDate,NString pEtaxConsentUserId,NString pNewHireInd) {
			
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("PB_EMPLOYEE_RULES.P_VALIDATE", DbManager.getDataBaseFactory());
			
			cmd.addParameter(DbTypes.createStructType("P_VAL_REC_INOUT", pValRecInout.val, PbEmployee.EmployeeRecRow.class, true));
			cmd.addParameter("@P_OPERATION_TYPE", pOperationType);
			cmd.addParameter("@P_PIDM", pPidm);
			cmd.addParameter("@P_EMPL_STATUS", pEmplStatus);
			cmd.addParameter("@P_COAS_CODE_HOME", pCoasCodeHome);
			...
			cmd.execute();
			pValRecInout.val = cmd.getParameterValue("@P_VAL_REC_INOUT", PbEmployee.EmployeeRecRow.class);
		...
		public static void pValidateDelete(NNumber pPidm) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("PB_EMPLOYEE_RULES.P_VALIDATE_DELETE", DbManager.getDataBaseFactory());
