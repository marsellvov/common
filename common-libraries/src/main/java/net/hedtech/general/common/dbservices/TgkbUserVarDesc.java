...
public class TgkbUserVarDesc {
		public static NInteger fApiVersion() {
			
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("TGKB_USER_VAR_DESC.F_API_VERSION", DbManager.getDataBaseFactory());
		...
		public static NString fExists(NString pAidyCode,NString pRowid) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("TGKB_USER_VAR_DESC.F_EXISTS", DbManager.getDataBaseFactory());
		...
		public static NString fIsequal(UserVarDescRecRow recOne,UserVarDescRecRow recTwo) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("TGKB_USER_VAR_DESC.F_ISEQUAL", DbManager.getDataBaseFactory());
		...
		public static DataCursor fQueryAll(NString pAidyCode) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("TGKB_USER_VAR_DESC.F_QUERY_ALL", DbManager.getDataBaseFactory());
		...
		public static DataCursor fQueryByRowid(NString pRowid) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("TGKB_USER_VAR_DESC.F_QUERY_BY_ROWID", DbManager.getDataBaseFactory());
		...
		public static DataCursor fQueryOne(NString pAidyCode) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("TGKB_USER_VAR_DESC.F_QUERY_ONE", DbManager.getDataBaseFactory());
		...
		public static DataCursor fQueryOneLock(NString pAidyCode,NString pRowid) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("TGKB_USER_VAR_DESC.F_QUERY_ONE_LOCK", DbManager.getDataBaseFactory());
...
//			
//			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("TGKB_USER_VAR_DESC.P_CREATE", DbManager.getDataBaseFactory());
//			
//			cmd.addParameter("@P_AIDY_CODE", pAidyCode);
...
//		}
		...
		public static void pDelete(NString pAidyCode,NString pRowid) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("TGKB_USER_VAR_DESC.P_DELETE", DbManager.getDataBaseFactory());
		...
		public static void pLock(NString pAidyCode,Ref<NString> pRowidInout) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("TGKB_USER_VAR_DESC.P_LOCK", DbManager.getDataBaseFactory());
...
//			
//			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("TGKB_USER_VAR_DESC.P_UPDATE", DbManager.getDataBaseFactory());
//			
//			cmd.addParameter("@P_AIDY_CODE", pAidyCode);
//			cmd.addParameter("@P_USER_ID", pUserId);
//			cmd.addParameter("@P_DATA_ORIGIN", pDataOrigin);
