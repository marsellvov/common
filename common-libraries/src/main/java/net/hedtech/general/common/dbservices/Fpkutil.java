...
public class Fpkutil {
		public static void appenderror(Ref<NString> origerror,NString newerror) {
			
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("FPKUTIL.APPENDERROR", DbManager.getDataBaseFactory());
...
//		}
		...
		public static NBool fFgbenchExists(NString encumbNum) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("FPKUTIL.F_FGBENCH_EXISTS", DbManager.getDataBaseFactory());
		...
		public static NString fGetAutobuyrCode(NString chartCode,NString orgnCode,NDate transDate,NString commCode) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("FPKUTIL.F_GET_AUTOBUYR_CODE", DbManager.getDataBaseFactory());
		...
		public static NString fGetSuccessMessage(NString docname,NString docCode,NString forwardProcess) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("FPKUTIL.F_GET_SUCCESS_MESSAGE", DbManager.getDataBaseFactory());
		...
		public static NNumber fGetTaxAmount(NString tgrp,NDate asofdate,NNumber apprAmt,NNumber discAmt,NNumber addlAmt) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("FPKUTIL.F_GET_TAX_AMOUNT", DbManager.getDataBaseFactory());
...
//			
//			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("FPKUTIL.F_GET_TAX_DETAILS", DbManager.getDataBaseFactory());
//			
...
//		}
		...
		public static NString fIsVendorEdi(NNumber vendPidm,NString vendAtyp,NNumber vendAtypSeq,NString docType) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("FPKUTIL.F_IS_VENDOR_EDI", DbManager.getDataBaseFactory());
		...
		public static void pCalcEncumbAdjustment(NString pPoCode,NNumber pChangeSeqNum) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("FPKUTIL.P_CALC_ENCUMB_ADJUSTMENT", DbManager.getDataBaseFactory());
		...
		public static void pCheckDocDates(NDate transDate,NDate orderDate,NDate delivDate,Ref<NString> errorMesg) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("FPKUTIL.P_CHECK_DOC_DATES", DbManager.getDataBaseFactory());
		...
		public static void pForwardDocument(NNumber docType,NString docDesc,NString docCode,NString userId,NString completeInd,NString approvalInd,Ref<NString> errorMesg,Ref<NString> successMesg,NNumber docTotal,NNumber chgSeq,NString bankCode,NString subNum) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("FPKUTIL.P_FORWARD_DOCUMENT", DbManager.getDataBaseFactory());
...
//			
//			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("FPKUTIL.P_IS_DOCACCTG_POSTABLE", DbManager.getDataBaseFactory());
//			
...
//			
//			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("FPKUTIL.P_IS_FOAP_POSTABLE", DbManager.getDataBaseFactory());
//			
...
//			
//			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("FPKUTIL.P_SCRUBCHAR", DbManager.getDataBaseFactory());
//			
...
//			
//			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("FPKUTIL.P_SCRUBDATE", DbManager.getDataBaseFactory());
//			
...
//			
//			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("FPKUTIL.P_SCRUBNUMB", DbManager.getDataBaseFactory());
//			
//			cmd.addParameter("@INCODE", incode);
//			cmd.addParameter("@MAXLENGTH", maxlength);
//			cmd.addParameter("@OUTCODE", outcode, true);
...
//			
//			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("FPKUTIL.TABLE_TO_STRING", DbManager.getDataBaseFactory());
//			
//			cmd.addReturnParameter(NString.class);
