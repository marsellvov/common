...
public class RpkAwardValidationUs {
		public static void pValidateAward(NString pAidyCode,NNumber pPidm,NString pFundCode,NNumber pAwardAmt,NNumber pOrigAwardAmt,NString pUnmetNeedOvrdeInd,NString pReplaceTfcOvrdeInd,NString pTreqOvrdeInd,NString pFedLimitOvrdeInd,NString pFundLimitOvrdeInd,NString pOverrideYrInColl,NString pOverrideNoPell,NNumber pBudgetAmt,NNumber pResourceAmt,NNumber pReduceNeedAmt,NNumber pReplaceEfcAmt,NNumber pEfcAmt,NNumber pUnmetNeed,NString pLoadInd,NString pSimulateSw,Ref<NString> pUnmetNeedErrIndOut,Ref<NString> pLoanMaxErrIndOut,Ref<NString> pCumLimitErrIndOut,Ref<NString> pMaxLimitErrIndOut,Ref<NNumber> pMaxAnnualLimitOut,Ref<NNumber> pHoldRemainAmtOut,Ref<NNumber> pReduceAwardAmtOut,Ref<NString> pErrorMessageOut) {
			
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("RPK_AWARD_VALIDATION_US.P_VALIDATE_AWARD", DbManager.getDataBaseFactory());
