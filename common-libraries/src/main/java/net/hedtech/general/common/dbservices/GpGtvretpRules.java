...
public class GpGtvretpRules {
		public static void pRegisterEntity(NNumber pOperationType,NString pInternalRecordId) {
			
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("GP_GTVRETP_RULES.P_REGISTER_ENTITY", DbManager.getDataBaseFactory());
		...
		public static void pValidate(NString pCode,NString pDesc,NString pSystemReqInd,NString pUserId,NDate pCreateDate,NString pCreateUser) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("GP_GTVRETP_RULES.P_VALIDATE", DbManager.getDataBaseFactory());
