...
public class Cmprinfo {
		public static void pInfoTextDisplay(NString module,NString tableType,NString wmnuTableName,NString infoTableName,NString wmnuTableOwner,NString infoTableOwner,NString instTableOwner) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("CMPRINFO.P_INFO_TEXT_DISPLAY", DbManager.getDataBaseFactory());
		...
		public static void pStart(NString returnCode) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("CMPRINFO.P_START", DbManager.getDataBaseFactory());
