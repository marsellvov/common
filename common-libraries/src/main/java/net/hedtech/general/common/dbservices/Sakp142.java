...
public class Sakp142 {
		public static void pP142Proc(NNumber aidm,NNumber applSeqno,NNumber pcolSeqno,NString wappCode,NString procLabel,Ref<NString> errorInd) {
			
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("SAKP142.P_P142_PROC", DbManager.getDataBaseFactory());
