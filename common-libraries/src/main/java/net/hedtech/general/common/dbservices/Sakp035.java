...
public class Sakp035 {
		public static void pP035Proc(NNumber aidm,NNumber applSeqno,NNumber seqno,NString wappCode,NString aplsCode,NString procLabel,Ref<NString> errorInd) {
			
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("SAKP035.P_P035_PROC", DbManager.getDataBaseFactory());
