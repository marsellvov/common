...
public class SbCourseRules {
		public static void pRegisterEntity(NNumber pOperationType,NString pInternalRecordId) {
			
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("SB_COURSE_RULES.P_REGISTER_ENTITY", DbManager.getDataBaseFactory());
		...
		public static void pValidate(NString pSubjCode,NString pCrseNumb,NString pEffTerm,NString pCollCode,NString pDivsCode,NString pDeptCode,NString pCstaCode,NString pTitle,NString pCipcCode,NString pCreditHrInd,NNumber pCreditHrLow,NNumber pCreditHrHigh,NString pLecHrInd,NNumber pLecHrLow,NNumber pLecHrHigh,NString pLabHrInd,NNumber pLabHrLow,NNumber pLabHrHigh,NString pOthHrInd,NNumber pOthHrLow,NNumber pOthHrHigh,NString pBillHrInd,NNumber pBillHrLow,NNumber pBillHrHigh,NString pAprvCode,NNumber pRepeatLimit,NString pPwavCode,NString pTuiwInd,NString pAddFeesInd,NNumber pContHrLow,NString pContHrInd,NNumber pContHrHigh,NString pCeuInd,NString pRepsCode,NNumber pMaxRptUnits,NString pCappPrereqTestInd,NString pDuntCode,NNumber pNumberOfUnits,NString pDataOrigin,NString pUserId,NString pPrereqChkMethodCde) {
			
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("SB_COURSE_RULES.P_VALIDATE", DbManager.getDataBaseFactory());
		...
		public static void pValidateChildren(NBool pBaseExists,NString pCeuInd,NString pLevlCode,NString pGmodCode,NString pSchdCode,NString pInsmCode) {
			
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("SB_COURSE_RULES.P_VALIDATE_CHILDREN", DbManager.getDataBaseFactory());
			
			cmd.addParameter("@P_BASE_EXISTS", pBaseExists);
			cmd.addParameter("@P_CEU_IND", pCeuInd);
