...
public class GbGoradidRules {
		public static void pRegisterEntity(NNumber pOperationType,NString pInternalRecordId) {
			
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("GB_GORADID_RULES.P_REGISTER_ENTITY", DbManager.getDataBaseFactory());
		...
		public static void pValidate(NNumber pPidm,NString pAdditionalId,NString pAdidCode,NString pUserId,NString pDataOrigin) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("GB_GORADID_RULES.P_VALIDATE", DbManager.getDataBaseFactory());
