...
public class PbEmployee {
		public static NInteger fApiVersion() {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("PB_EMPLOYEE.F_API_VERSION", DbManager.getDataBaseFactory());
		...
		public static NString fExists(NNumber pPidm,NString pRowid) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("PB_EMPLOYEE.F_EXISTS", DbManager.getDataBaseFactory());
		...
		public static NString fIsequal(EmployeeRecRow recOne,EmployeeRecRow recTwo) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("PB_EMPLOYEE.F_ISEQUAL", DbManager.getDataBaseFactory());
		...
		public static DataCursor fQueryAll() {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("PB_EMPLOYEE.F_QUERY_ALL", DbManager.getDataBaseFactory());
		...
		public static DataCursor fQueryByRowid(NString pRowid) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("PB_EMPLOYEE.F_QUERY_BY_ROWID", DbManager.getDataBaseFactory());
		...
		public static DataCursor fQueryOne(NNumber pPidm) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("PB_EMPLOYEE.F_QUERY_ONE", DbManager.getDataBaseFactory());
		...
		public static DataCursor fQueryOneLock(NNumber pPidm,NString pRowid) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("PB_EMPLOYEE.F_QUERY_ONE_LOCK", DbManager.getDataBaseFactory());
		...
		public static void pCreate(NNumber pPidm,NString pEmplStatus,NString pCoasCodeHome,NString pOrgnCodeHome,NString pCoasCodeDist,NString pOrgnCodeDist,NString pEclsCode,NString pLcatCode,NString pBcatCode,NDate pFirstHireDate,NDate pCurrentHireDate,NDate pAdjServiceDate,NDate pSeniorityDate,NString pLreaCode,NDate pLoaBegDate,NDate pLoaEndDate,NString pTreaCode,NDate pTermDate,NString pI9FormInd,NDate pI9Date,NDate pI9ExpireDate,NString pWkprCode,NString pFlsaInd,NString pStgrCode,NNumber pDaysInCanada,NString p1042RecipientCd,NString pInternalFtPtInd,NString pDicdCode,NString pEgrpCode,NString pIpedsSoftMoneyInd,NDate pFirstWorkDate,NDate pLastWorkDate,NString pCalifPensionInd,NString pNrsiCode,NString pSsnLastName,NString pSsnFirstName,NString pSsnMi,NString pSsnSuffix,NString pJblnCode,NString pCollCode,NString pCampCode,NString pUserId,NString pDataOrigin,NString pEw2ConsentInd,NDate pEw2ConsentDate,NString pEw2ConsentUserId,Ref<byte[]> pRowidOut,NString pIpedsPrimaryFunction,NString pIpedsMedDentalInd,NString pEtaxConsentInd,NDate pEtaxConsentDate,NString pEtaxConsentUserId,NString pNewHireInd) {
			
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("PB_EMPLOYEE.P_CREATE", DbManager.getDataBaseFactory());
			...
			cmd.execute(); 
			pRowidOut.val = cmd.getParameterValue("@P_ROWID_OUT", String.class).getBytes(); //cmd.getParameterValue("@P_ROWID_OUT", byte[].class);
		...
		public static void pDelete(NNumber pPidm,java.sql.RowId pRowid) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("PB_EMPLOYEE.P_DELETE", DbManager.getDataBaseFactory());
		...
		public static void pLock(NNumber pPidm,Ref<NString> pRowidInout) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("PB_EMPLOYEE.P_LOCK", DbManager.getDataBaseFactory());
		...
		public static void pUpdate(NNumber pPidm,NString pEmplStatus,NString pCoasCodeHome,NString pOrgnCodeHome,NString pCoasCodeDist,NString pOrgnCodeDist,NString pEclsCode,NString pLcatCode,NString pBcatCode,NDate pFirstHireDate,NDate pCurrentHireDate,NDate pAdjServiceDate,NDate pSeniorityDate,NString pLreaCode,NDate pLoaBegDate,NDate pLoaEndDate,NString pTreaCode,NDate pTermDate,NString pI9FormInd,NDate pI9Date,NDate pI9ExpireDate,NString pWkprCode,NString pFlsaInd,NString pStgrCode,NNumber pDaysInCanada,NString p1042RecipientCd,NString pInternalFtPtInd,NString pDicdCode,NString pEgrpCode,NString pIpedsSoftMoneyInd,NDate pFirstWorkDate,NDate pLastWorkDate,NString pCalifPensionInd,NString pNrsiCode,NString pSsnLastName,NString pSsnFirstName,NString pSsnMi,NString pSsnSuffix,NString pJblnCode,NString pCollCode,NString pCampCode,NString pUserId,NString pDataOrigin,NString pEw2ConsentInd,NDate pEw2ConsentDate,NString pEw2ConsentUserId,java.sql.RowId pRowid,NString pIpedsPrimaryFunction,NString pIpedsMedDentalInd,NString pEtaxConsentInd,NDate pEtaxConsentDate,NString pEtaxConsentUserId,NString pNewHireInd) {
			
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("PB_EMPLOYEE.P_UPDATE", DbManager.getDataBaseFactory());
	...
	@DbRecordType(id="EmployeeRecRow", dataSourceName="EMPLOYEE_REC")
