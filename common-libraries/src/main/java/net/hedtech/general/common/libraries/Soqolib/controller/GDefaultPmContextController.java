...
END;
		*/
		...
		{
				getContainer().getGoqrpls().getGNavigationFrame().executeMenu(toStr("OPTIONS.SUB_MENU_01"));
			}
...
END;
		*/
		...
		{
				getContainer().getGoqrpls().getGNavigationFrame().executeMenu(toStr("OPTIONS.SUB_MENU_02"));
			}
...
END;
		*/
		...
		{
				getContainer().getGoqrpls().getGNavigationFrame().executeMenu(toStr("OPTIONS.SUB_MENU_03"));
			}
...
END;
		*/
		...
		{
				getContainer().getGoqrpls().getGNavigationFrame().executeMenu(toStr("OPTIONS.SUB_MENU_04"));
			}
...
END;
		*/
		...
		{
				getContainer().getGoqrpls().getGNavigationFrame().executeMenu(toStr("OPTIONS.SUB_MENU_05"));
			}
...
END;
		*/
		...
		{
				getContainer().getGoqrpls().getGNavigationFrame().executeMenu(toStr("OPTIONS.SUB_MENU_06"));
			}
...
END;
		*/
		...
		{
				getContainer().getGoqrpls().getGNavigationFrame().executeMenu(toStr("OPTIONS.SUB_MENU_07"));
			}
...
END;
		*/
		...
		{
				getContainer().getGoqrpls().getGNavigationFrame().executeMenu(toStr("OPTIONS.SUB_MENU_08"));
			}
...
END;
		*/
		...
		{
				getContainer().getGoqrpls().getGNavigationFrame().executeMenu(toStr("OPTIONS.SUB_MENU_09"));
			}
...
END;
		*/
		...
		{
				getContainer().getGoqrpls().getGNavigationFrame().executeMenu(toStr("OPTIONS.SUB_MENU_10"));
			}
...
END;
		*/
		...
		{
				getContainer().getGoqrpls().getGNavigationFrame().executeMenu(toStr("OPTIONS.SUB_MENU_11"));
			}
...
END;
		*/
		...
		{
				getContainer().getGoqrpls().getGNavigationFrame().executeMenu(toStr("OPTIONS.SUB_MENU_12"));
			}
...
END;
		*/
		...
		{
				getContainer().getGoqrpls().getGNavigationFrame().executeMenu(toStr("OPTIONS.SUB_MENU_13"));
			}
...
END;
		*/
		...
		{
				getContainer().getGoqrpls().getGNavigationFrame().executeMenu(toStr("OPTIONS.SUB_MENU_14"));
			}
...
END;
		*/
		...
		{
				getContainer().getGoqrpls().getGNavigationFrame().executeMenu(toStr("OPTIONS.SUB_MENU_15"));
			}
...
END;
		*/
		...
		{
				getContainer().getGoqrpls().getGNavigationFrame().executeMenu(toStr("OPTIONS.SUB_MENU_16"));
			}
...
END;
		*/
		...
		{
				getContainer().getGoqrpls().getGNavigationFrame().executeMenu(toStr("OPTIONS.SUB_MENU_17"));
			}
...
END;
		*/
		...
		{
				getContainer().getGoqrpls().getGNavigationFrame().executeMenu(toStr("OPTIONS.SUB_MENU_18"));
			}
...
END;
		*/
		...
		{
				getContainer().getGoqrpls().getGNavigationFrame().executeMenu(toStr("OPTIONS.SUB_MENU_19"));
			}
...
END;
		*/
		...
		{
				getContainer().getGoqrpls().getGNavigationFrame().executeMenu(toStr("OPTIONS.SUB_MENU_20"));
			}
...
END;
		*/
		...
		{
				getContainer().getGoqrpls().getGNavigationFrame().executeMenu(toStr("OPTIONS.SUB_MENU_21"));
			}
...
END;
		*/
		...
		{
				getContainer().getGoqrpls().getGNavigationFrame().executeMenu(toStr("OPTIONS.SUB_MENU_22"));
			}
...
END;
		*/
		...
		{
				getContainer().getGoqrpls().getGNavigationFrame().executeMenu(toStr("OPTIONS.SUB_MENU_23"));
			}
...
END;
		*/
		...
		{
				getContainer().getGoqrpls().getGNavigationFrame().executeMenu(toStr("OPTIONS.SUB_MENU_24"));
			}
