...
public class Sakp070 {
		public static void pP070Proc(NNumber aidm,NNumber applSeqno,NNumber persSeqno,NNumber seqno,NString wappCode,NString procLabel,Ref<NString> errorInd) {
			
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("SAKP070.P_P070_PROC", DbManager.getDataBaseFactory());
