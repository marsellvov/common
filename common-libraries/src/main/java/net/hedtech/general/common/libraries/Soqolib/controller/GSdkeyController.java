...
public class GSdkeyController extends AbstractSupportCodeObject {


	private net.hedtech.general.common.libraries.Goqolib.controller.GSdkeyController getGoqolibGSdkeyController() {
		return (net.hedtech.general.common.libraries.Goqolib.controller.GSdkeyController) this.getContainer().getTaskPart("GOQOLIB").getSupportCodeManager().getPackage("G$_SDKEY");
	}	
	
	public GSdkeyController(ISupportCodeContainer container) 
	{
		super(container);
	}
	...
	//action methods generated from triggers
		...
		*/
		...
		public void govsdavValueAsCharLbt_click()
		{
				...
				getGoqolibGSdkeyController().govsdavValueAsCharLbt_click();
			}
		 ...
		 *<b>Migration Comments</b>
		 * Generated from trigger:
		 * SDE_CLOSE_BTN.WHEN-MOUSE-CLICK
		 *
		 *
		 *</p>
		*/
		...
		public void sdeCloseBtn_click()
		{
				...
				getGoqolibGSdkeyController().sdeCloseBtn_buttonClick();
			}
