...
public class Viewmenu {
		public static void pMenuDisplay(NString module,NString tableType,NString wmnuTableName,NString menuTableName,NString wmnuTableOwner,NString menuTableOwner,NString instTableOwner) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("VIEWMENU.P_MENU_DISPLAY", DbManager.getDataBaseFactory());
		...
		public static void pStart(NString returnCode) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("VIEWMENU.P_START", DbManager.getDataBaseFactory());
