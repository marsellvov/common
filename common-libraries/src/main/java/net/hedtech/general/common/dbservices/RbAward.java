...
public class RbAward {
		public static NInteger fApiVersion() {
			
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("RB_AWARD.F_API_VERSION", DbManager.getDataBaseFactory());
		...
		public static NString fExists(NNumber pPidm,NString pAidyCode,NString pFundCode,NString pRowid) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("RB_AWARD.F_EXISTS", DbManager.getDataBaseFactory());
		...
		public static NString fIsequal(AwardRecRow recOne,AwardRecRow recTwo) {
			
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("RB_AWARD.F_ISEQUAL", DbManager.getDataBaseFactory());
			
			cmd.addReturnParameter(NString.class);
			cmd.addParameter(DbTypes.createStructType("REC_ONE", recOne, AwardRecRow.class ));
			cmd.addParameter(DbTypes.createStructType("REC_TWO", recTwo, AwardRecRow.class ));
		...
		public static NString fMixedStatus(NNumber pPidm,NString pAidyCode,NString pFundCode) {
			
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("RB_AWARD.F_MIXED_STATUS", DbManager.getDataBaseFactory());
		...
		public static DataCursor fQueryAll(NNumber pPidm,NString pAidyCode,NString pFundCode) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("RB_AWARD.F_QUERY_ALL", DbManager.getDataBaseFactory());
		...
		public static DataCursor fQueryByRowid(NString pRowid) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("RB_AWARD.F_QUERY_BY_ROWID", DbManager.getDataBaseFactory());
		...
		public static DataCursor fQueryOne(NNumber pPidm,NString pAidyCode,NString pFundCode) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("RB_AWARD.F_QUERY_ONE", DbManager.getDataBaseFactory());
		...
		public static DataCursor fQueryOneLock(NNumber pPidm,NString pAidyCode,NString pFundCode,NString pRowid) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("RB_AWARD.F_QUERY_ONE_LOCK", DbManager.getDataBaseFactory());
		...
		public static void pCreate(NString pAidyCode,NNumber pPidm,NString pFundCode,NString pAwstCode,NDate pAwstDate,NString pSysInd,NString pLockInd,NString pUnmetNeedOvrdeInd,NString pReplaceTfcOvrdeInd,NString pTreqOvrdeInd,NString pFedLimitOvrdeInd,NString pFundLimitOvrdeInd,NDate pOfferExpDate,NNumber pAcceptAmt,NDate pAcceptDate,NNumber pAuthorizeAmt,NDate pAuthorizeDate,NNumber pMemoAmt,NDate pMemoDate,NNumber pPaidAmt,NDate pPaidDate,NNumber pOrigOfferAmt,NDate pOrigOfferDate,NNumber pOfferAmt,NDate pOfferDate,NNumber pDeclineAmt,NDate pDeclineDate,NNumber pCancelAmt,NDate pCancelDate,NString pInfoAccessInd,NDate pLastWebUpdate,NString pUserId,NString pOverrideYrInColl,NString pDataOrigin,NString pOverrideNoPell,NString pOverrideFundRule,NString pCallingProcess,Ref<NString> pRowidOut) {
			
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("RB_AWARD.P_CREATE", DbManager.getDataBaseFactory());
		...
		public static void pDelete(NNumber pPidm,NString pAidyCode,NString pFundCode,NString pCallingProcess,NString pRowid) {
			
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("RB_AWARD.P_DELETE", DbManager.getDataBaseFactory());
		...
		public static void pLock(NNumber pPidm,NString pAidyCode,NString pFundCode,Ref<NString> pRowidInout) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("RB_AWARD.P_LOCK", DbManager.getDataBaseFactory());
		...
		public static void pUpdate(NString pAidyCode,NNumber pPidm,NString pFundCode,NString pAwstCode,NDate pAwstDate,NString pSysInd,NString pLockInd,NString pUnmetNeedOvrdeInd,NString pReplaceTfcOvrdeInd,NString pTreqOvrdeInd,NString pFedLimitOvrdeInd,NString pFundLimitOvrdeInd,NDate pOfferExpDate,NNumber pAcceptAmt,NDate pAcceptDate,NNumber pAuthorizeAmt,NDate pAuthorizeDate,NNumber pMemoAmt,NDate pMemoDate,NNumber pPaidAmt,NDate pPaidDate,NNumber pOrigOfferAmt,NDate pOrigOfferDate,NNumber pOfferAmt,NDate pOfferDate,NNumber pDeclineAmt,NDate pDeclineDate,NNumber pCancelAmt,NDate pCancelDate,NString pInfoAccessInd,NDate pLastWebUpdate,NString pUserId,NString pOverrideYrInColl,NString pDataOrigin,NString pOverrideNoPell,NString pOverrideFundRule,NString pCallingProcess,NString pRowid) {
			
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("RB_AWARD.P_UPDATE", DbManager.getDataBaseFactory());
	...
	@DbRecordType(id="AwardRecRow", dataSourceName="AWARD_REC")
	public static class AwardRecRow
	{
		...
		@DbRecordField(dataSourceName="R_LAST_WEB_UPDATE")
		public NDate RLastWebUpdate;
