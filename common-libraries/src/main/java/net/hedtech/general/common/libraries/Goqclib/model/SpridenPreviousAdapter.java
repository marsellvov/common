...
public class SpridenPreviousAdapter extends BaseRowAdapter{
	

	public SpridenPreviousAdapter(DataRow row, IDBBusinessObject businessObject) {
	...
	public void setPreviousNtypDesc(NString value){
		this.setValue("PREVIOUS_NTYP_DESC", value.getValue());
	}


	public NString getPreviousNtypDesc(){
		NString v = new NString((String)this.getValue("PREVIOUS_NTYP_DESC"));
		return v;
	}
	...
	// F2J_TODO : Item SPRIDEN_PIDM has the "Copy Value from Item" property defined, with value: KEY_BLOCK.PIDM                  
	...
	public void setDoRequery(NString value){
		this.setValue("DO_REQUERY", value.getValue());
	}


	public NString getDoRequery(){
		NString v = new NString((String)this.getValue("DO_REQUERY"));
		return v;
	}
