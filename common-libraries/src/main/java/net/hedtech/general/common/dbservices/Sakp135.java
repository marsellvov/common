...
public class Sakp135 {
		public static void pP135Proc(NNumber aidm,NNumber applSeqno,NNumber hschSeqno,NString wappCode,NString procLabel,Ref<NString> errorInd) {
			
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("SAKP135.P_P135_PROC", DbManager.getDataBaseFactory());
