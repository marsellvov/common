...
public class Rekci07 {
		public static NString fGetVersion() {
			
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("REKCI07.F_GET_VERSION", DbManager.getDataBaseFactory());
...
//			
//			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("REKCI07.P_UPDATE_DLPLUS_DISBURSEMENTS", DbManager.getDataBaseFactory());
//			
//			cmd.addParameter("@P_AIDY_CODE", pAidyCode);
//			cmd.addParameter("@P_DOCUMENT_ID", pDocumentId);
//			cmd.addParameter("@P_DOCUMENT_TYPE_CODE", pDocumentTypeCode);
...
//			
//			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("REKCI07.P_UPDATE_DLPLUS_ORIGINATIONS", DbManager.getDataBaseFactory());
//			
//			cmd.addParameter("@P_AIDY_CODE", pAidyCode);
//			cmd.addParameter("@P_DOCUMENT_ID", pDocumentId);
//			cmd.addParameter("@P_SSN", pSsn);
...
//			
//			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("REKCI07.P_UPDATE_DLSUB_DISBURSEMENTS", DbManager.getDataBaseFactory());
//			
//			cmd.addParameter("@P_AIDY_CODE", pAidyCode);
//			cmd.addParameter("@P_DOCUMENT_ID", pDocumentId);
//			cmd.addParameter("@P_DOCUMENT_TYPE_CODE", pDocumentTypeCode);
...
//			
//			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("REKCI07.P_UPDATE_DLSUB_ORIGINATIONS", DbManager.getDataBaseFactory());
//			
//			cmd.addParameter("@P_AIDY_CODE", pAidyCode);
//			cmd.addParameter("@P_DOCUMENT_ID", pDocumentId);
//			cmd.addParameter("@P_SSN", pSsn);
...
//			
//			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("REKCI07.P_UPDATE_DLUNSUB_DISBURSEMENTS", DbManager.getDataBaseFactory());
//			
//			cmd.addParameter("@P_AIDY_CODE", pAidyCode);
//			cmd.addParameter("@P_DOCUMENT_ID", pDocumentId);
//			cmd.addParameter("@P_DOCUMENT_TYPE_CODE", pDocumentTypeCode);
...
//			
//			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("REKCI07.P_UPDATE_DLUNSUB_ORIGINATIONS", DbManager.getDataBaseFactory());
//			
//			cmd.addParameter("@P_AIDY_CODE", pAidyCode);
//			cmd.addParameter("@P_DOCUMENT_ID", pDocumentId);
//			cmd.addParameter("@P_SSN", pSsn);
...
//			
//			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("REKCI07.P_UPDATE_GPLUS_DISBURSEMENTS", DbManager.getDataBaseFactory());
//			
//			cmd.addParameter("@P_AIDY_CODE", pAidyCode);
//			cmd.addParameter("@P_DOCUMENT_ID", pDocumentId);
//			cmd.addParameter("@P_DOCUMENT_TYPE_CODE", pDocumentTypeCode);
...
//			
//			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("REKCI07.P_UPDATE_GPLUS_ORIGINATIONS", DbManager.getDataBaseFactory());
//			
//			cmd.addParameter("@P_AIDY_CODE", pAidyCode);
//			cmd.addParameter("@P_DOCUMENT_ID", pDocumentId);
//			cmd.addParameter("@P_SSN", pSsn);
...
//			
//			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("REKCI07.P_UPDATE_PELL_DISBURSEMENTS", DbManager.getDataBaseFactory());
//			
//			cmd.addParameter("@P_AIDY_CODE", pAidyCode);
//			cmd.addParameter("@P_DOCUMENT_ID", pDocumentId);
//			cmd.addParameter("@P_SSN", pSsn);
...
//		}
//		
//		public static void pUpdatePellOriginations(NString pAidyCode,NString pDocumentId,NString pSsn,NString pLastName,NDate pBirthDate,NString pDocumentTypeCode,NString pIdStatusCde,List<StringNtRow> pRejectCodes,NString pOrigStatusCde,NString pAcptSarTranNo,NNumber pAcptAmtDue,NNumber pAcptAttendCost,NString pAcptLowCostCde,NString pPrisonInd,NString pAcptVerStatus,List<StringNtRow> pFsaCode,NDate pAcptEnrollmentDate,NNumber pSchPellGrant,NString pAcptCurrentSsn,NDate pAcptBirthDate,NString pAcptLastName,NString pAcptFirstName,NString pAcptMi,NNumber pNegPendingAmt,List<StringNtRow> pEditRejects,List<DateNtRow> pAcptEstDisbDates,List<StringNtRow> pEditField,List<StringNtRow> pEditValue,List<StringNtRow> pRejectFields) {
//			
//			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("REKCI07.P_UPDATE_PELL_ORIGINATIONS", DbManager.getDataBaseFactory());
//			
//			cmd.addParameter("@P_AIDY_CODE", pAidyCode);
//			cmd.addParameter("@P_DOCUMENT_ID", pDocumentId);
//			cmd.addParameter("@P_SSN", pSsn);
...
//		}
		...
		public static void pUpdateRercoddReceipt(NString pAidyCode,NString pDocumentId,NDate pCreatedDateTime,NString pDocumentStatusCode,NString pDocumentType) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("REKCI07.P_UPDATE_RERCODD_RECEIPT", DbManager.getDataBaseFactory());
		...
		public static void pUpdateRercoddResponse(NString pAidyCode,NString pDocumentId,NDate pCreatedDateTime,NString pDocumentStatusCode,NString pDocumentType) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("REKCI07.P_UPDATE_RERCODD_RESPONSE", DbManager.getDataBaseFactory());
...
//			
//			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("REKCI07.P_UPDATE_SMART_DISBURSEMENTS", DbManager.getDataBaseFactory());
//			
//			cmd.addParameter("@P_AIDY_CODE", pAidyCode);
//			cmd.addParameter("@P_DOCUMENT_ID", pDocumentId);
//			cmd.addParameter("@P_SSN", pSsn);
...
//		}
//		
//		public static void pUpdateSmartOriginations(NString pAidyCode,NString pDocumentId,NString pSsn,NString pLastName,NDate pBirthDate,NString pDocumentTypeCode,NString pIdStatusCde,List<StringNtRow> pRejectCodes,NString pOrigStatusCde,NString pAcptSarTranNo,NNumber pAcptAwardAmount,List<StringNtRow> pFsaCode,NDate pAcptEnrollmentDate,NNumber pNegPendingAmt,List<StringNtRow> pEditRejects,List<StringNtRow> pEditField,List<StringNtRow> pEditValue,List<StringNtRow> pRejectFields,NNumber pYtdAmtPaid,NString pAcptYrInColl,NString pAcptCipCode,NString pAwardId) {
//			
//			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("REKCI07.P_UPDATE_SMART_ORIGINATIONS", DbManager.getDataBaseFactory());
//			
//			cmd.addParameter("@P_AIDY_CODE", pAidyCode);
//			cmd.addParameter("@P_DOCUMENT_ID", pDocumentId);
//			cmd.addParameter("@P_SSN", pSsn);
