...
public class Taftpcr {
		public static NString fTpContractCourseReq(NNumber vPidm,NString vTermCode,NNumber vStuPidm,NNumber vContractNumber) {
			
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("TAFTPCR.F_TP_CONTRACT_COURSE_REQ", DbManager.getDataBaseFactory());
		...
		public static NString fTpExemptionCourseReq(NString vExemptionCode,NString vTermCode,NNumber vStuPidm) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("TAFTPCR.F_TP_EXEMPTION_COURSE_REQ", DbManager.getDataBaseFactory());
