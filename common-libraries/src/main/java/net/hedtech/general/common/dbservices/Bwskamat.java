...
public class Bwskamat {
		public static void pDispappmaterials(NNumber appno,NString wsct,NString ud1,NString ud2,NString ud3,NString ud4,NString ud5,NString ud6,NString ud7,NString ud8,NString ud9,NString ud10) {
			
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("BWSKAMAT.P_DISPAPPMATERIALS", DbManager.getDataBaseFactory());
...
//		public static void pProcappmaterials(NNumber appno,NString wsct,List<Bwskalog.Varchar2TabtypeRow> matl,NString matlReq,NString submitBtn,NString ud1,NString ud2,NString ud3,NString ud4,NString ud5,NString ud6,NString ud7,NString ud8,NString ud9,NString ud10,NString ud1Seqno,NString ud2Seqno,NString ud3Seqno,NString ud4Seqno,NString ud5Seqno,NString ud6Seqno,NString ud7Seqno,NString ud8Seqno,NString ud9Seqno,NString ud10Seqno,NString ud1Req,NString ud2Req,NString ud3Req,NString ud4Req,NString ud5Req,NString ud6Req,NString ud7Req,NString ud8Req,NString ud9Req,NString ud10Req) {
//			
//			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("BWSKAMAT.P_PROCAPPMATERIALS", DbManager.getDataBaseFactory());
//			
//			cmd.addParameter("@APPNO", appno);
//			cmd.addParameter("@WSCT", wsct);
//			// cmd.addParameter(DbTypes.getTableType("MATL", "", matl, object.class));
//			cmd.addParameter("@MATL_REQ", matlReq);
