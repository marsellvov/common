...
public class Rekci100 {
		public static NString fGetVersion() {
			
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("REKCI100.F_GET_VERSION", DbManager.getDataBaseFactory());
...
//			
//			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("REKCI100.P_UPDATE_ACG_DISBURSEMENTS", DbManager.getDataBaseFactory());
//			
...
//			
//			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("REKCI100.P_UPDATE_ACG_ORIGINATIONS", DbManager.getDataBaseFactory());
//			
//			cmd.addParameter("@P_AIDY_CODE", pAidyCode);
//			cmd.addParameter("@P_DOCUMENT_ID", pDocumentId);
//			cmd.addParameter("@P_SSN", pSsn);
...
//		}
		...
		public static void pUpdateCounselingAck(NString pAidyCode,NString pDocumentId,NString pDocumentTypeCode,NDate pProcessDate,NString pSsn,NDate pBirthDate,NString pLastName,NString pFirstName,NString pMiddleInit,NString pAwardYear,NString pCounselingType,NDate pCompDate,NNumber pSequenceNo,NString pEntrReq,NString pEntrReqStatus) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("REKCI100.P_UPDATE_COUNSELING_ACK", DbManager.getDataBaseFactory());
...
//			
//			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("REKCI100.P_UPDATE_DLPLUS_DISBURSEMENTS", DbManager.getDataBaseFactory());
//			
//			cmd.addParameter("@P_AIDY_CODE", pAidyCode);
//			cmd.addParameter("@P_DOCUMENT_ID", pDocumentId);
//			cmd.addParameter("@P_DOCUMENT_TYPE_CODE", pDocumentTypeCode);
...
//			
//			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("REKCI100.P_UPDATE_DLPLUS_ORIGINATIONS", DbManager.getDataBaseFactory());
//			
//			cmd.addParameter("@P_AIDY_CODE", pAidyCode);
//			cmd.addParameter("@P_DOCUMENT_ID", pDocumentId);
//			cmd.addParameter("@P_SSN", pSsn);
...
//			
//			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("REKCI100.P_UPDATE_DLSUB_DISBURSEMENTS", DbManager.getDataBaseFactory());
//			
//			cmd.addParameter("@P_AIDY_CODE", pAidyCode);
//			cmd.addParameter("@P_DOCUMENT_ID", pDocumentId);
//			cmd.addParameter("@P_DOCUMENT_TYPE_CODE", pDocumentTypeCode);
...
//			
//			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("REKCI100.P_UPDATE_DLSUB_ORIGINATIONS", DbManager.getDataBaseFactory());
//			
//			cmd.addParameter("@P_AIDY_CODE", pAidyCode);
//			cmd.addParameter("@P_DOCUMENT_ID", pDocumentId);
//			cmd.addParameter("@P_SSN", pSsn);
...
//			
//			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("REKCI100.P_UPDATE_DLUNSUB_DISBURSEMENTS", DbManager.getDataBaseFactory());
//			
//			cmd.addParameter("@P_AIDY_CODE", pAidyCode);
//			cmd.addParameter("@P_DOCUMENT_ID", pDocumentId);
//			cmd.addParameter("@P_DOCUMENT_TYPE_CODE", pDocumentTypeCode);
...
//			
//			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("REKCI100.P_UPDATE_DLUNSUB_ORIGINATIONS", DbManager.getDataBaseFactory());
//			
//			cmd.addParameter("@P_AIDY_CODE", pAidyCode);
//			cmd.addParameter("@P_DOCUMENT_ID", pDocumentId);
//			cmd.addParameter("@P_SSN", pSsn);
...
//			
//			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("REKCI100.P_UPDATE_GPLUS_DISBURSEMENTS", DbManager.getDataBaseFactory());
//			
//			cmd.addParameter("@P_AIDY_CODE", pAidyCode);
//			cmd.addParameter("@P_DOCUMENT_ID", pDocumentId);
//			cmd.addParameter("@P_DOCUMENT_TYPE_CODE", pDocumentTypeCode);
...
//			
//			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("REKCI100.P_UPDATE_GPLUS_ORIGINATIONS", DbManager.getDataBaseFactory());
//			
//			cmd.addParameter("@P_AIDY_CODE", pAidyCode);
//			cmd.addParameter("@P_DOCUMENT_ID", pDocumentId);
//			cmd.addParameter("@P_SSN", pSsn);
...
//			
//			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("REKCI100.P_UPDATE_PELL_DISBURSEMENTS", DbManager.getDataBaseFactory());
//			
//			cmd.addParameter("@P_AIDY_CODE", pAidyCode);
//			cmd.addParameter("@P_DOCUMENT_ID", pDocumentId);
//			cmd.addParameter("@P_SSN", pSsn);
...
//			
//			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("REKCI100.P_UPDATE_PELL_ORIGINATIONS", DbManager.getDataBaseFactory());
//			
//			cmd.addParameter("@P_AIDY_CODE", pAidyCode);
//			cmd.addParameter("@P_DOCUMENT_ID", pDocumentId);
//			cmd.addParameter("@P_SSN", pSsn);
...
//		}
		...
		public static void pUpdateRercoddReceipt(NString pAidyCode,NString pDocumentId,NDate pCreatedDateTime,NString pDocumentStatusCode,NString pDocumentType) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("REKCI100.P_UPDATE_RERCODD_RECEIPT", DbManager.getDataBaseFactory());
		...
		public static void pUpdateRercoddResponse(NString pAidyCode,NString pDocumentId,NDate pCreatedDateTime,NString pDocumentStatusCode,NString pDocumentType) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("REKCI100.P_UPDATE_RERCODD_RESPONSE", DbManager.getDataBaseFactory());
...
//			
//			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("REKCI100.P_UPDATE_SMART_DISBURSEMENTS", DbManager.getDataBaseFactory());
//			
//			cmd.addParameter("@P_AIDY_CODE", pAidyCode);
//			cmd.addParameter("@P_DOCUMENT_ID", pDocumentId);
//			cmd.addParameter("@P_SSN", pSsn);
...
//			
//			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("REKCI100.P_UPDATE_SMART_ORIGINATIONS", DbManager.getDataBaseFactory());
//			
//			cmd.addParameter("@P_AIDY_CODE", pAidyCode);
//			cmd.addParameter("@P_DOCUMENT_ID", pDocumentId);
//			cmd.addParameter("@P_SSN", pSsn);
...
//			
//			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("REKCI100.P_UPDATE_TEACH_DISBURSEMENTS", DbManager.getDataBaseFactory());
//			
//			cmd.addParameter("@P_AIDY_CODE", pAidyCode);
//			cmd.addParameter("@P_DOCUMENT_ID", pDocumentId);
//			cmd.addParameter("@P_SSN", pSsn);
...
//			
//			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("REKCI100.P_UPDATE_TEACH_ORIGINATIONS", DbManager.getDataBaseFactory());
//			
//			cmd.addParameter("@P_AIDY_CODE", pAidyCode);
//			cmd.addParameter("@P_DOCUMENT_ID", pDocumentId);
//			cmd.addParameter("@P_SSN", pSsn);
