...
public class SbWlExclusion {
		public static NInteger fApiVersion() {
			
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("SB_WL_EXCLUSION.F_API_VERSION", DbManager.getDataBaseFactory());
		...
		public static NString fExists(NNumber pPrimaryKey,NString pRowid) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("SB_WL_EXCLUSION.F_EXISTS", DbManager.getDataBaseFactory());
		...
		public static NString fIsequal(WlExclusionRecRow recOne,WlExclusionRecRow recTwo) {
			
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("SB_WL_EXCLUSION.F_ISEQUAL", DbManager.getDataBaseFactory());
			
			cmd.addReturnParameter(NString.class);
			cmd.addParameter(DbTypes.createStructType("REC_ONE", recOne, WlExclusionRecRow.class ));
			cmd.addParameter(DbTypes.createStructType("REC_TWO", recTwo, WlExclusionRecRow.class ));
		...
		public static DataCursor fQueryAll(NNumber pPrimaryKey) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("SB_WL_EXCLUSION.F_QUERY_ALL", DbManager.getDataBaseFactory());
		...
		public static DataCursor fQueryByRowid(NString pRowid) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("SB_WL_EXCLUSION.F_QUERY_BY_ROWID", DbManager.getDataBaseFactory());
		...
		public static DataCursor fQueryOne(NNumber pPrimaryKey) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("SB_WL_EXCLUSION.F_QUERY_ONE", DbManager.getDataBaseFactory());
		...
		public static DataCursor fQueryOneLock(NNumber pPrimaryKey,NString pRowid) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("SB_WL_EXCLUSION.F_QUERY_ONE_LOCK", DbManager.getDataBaseFactory());
		...
		public static void pCreate(NString pTermCode,NString pUserId,NString pLevlCode,NString pCampCode,NString pCollCode,NString pDegcCode,NString pProgram,NString pClasCode,NString pAttsCode,NString pAstdCode,NString pChrtCode,NString pLfstCode,NString pMajrCode,NNumber pMinGpa,NNumber pMaxGpa,NString pDataOrigin,Ref<NString> pRowidOut) {
			
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("SB_WL_EXCLUSION.P_CREATE", DbManager.getDataBaseFactory());
		...
		public static void pDelete(NNumber pPrimaryKey,NString pRowid) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("SB_WL_EXCLUSION.P_DELETE", DbManager.getDataBaseFactory());
		...
		public static void pLock(NNumber pPrimaryKey,Ref<NString> pRowidInout) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("SB_WL_EXCLUSION.P_LOCK", DbManager.getDataBaseFactory());
		...
		public static void pUpdate(NNumber pPrimaryKey,NString pTermCode,NString pUserId,NString pLevlCode,NString pCampCode,NString pCollCode,NString pDegcCode,NString pProgram,NString pClasCode,NString pAttsCode,NString pAstdCode,NString pChrtCode,NString pLfstCode,NString pMajrCode,NNumber pMinGpa,NNumber pMaxGpa,NString pDataOrigin,NString pRowid) {
			
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("SB_WL_EXCLUSION.P_UPDATE", DbManager.getDataBaseFactory());
	...
	@DbRecordType(id="WlExclusionRecRow", dataSourceName="WL_EXCLUSION_REC")
	public static class WlExclusionRecRow
	{
