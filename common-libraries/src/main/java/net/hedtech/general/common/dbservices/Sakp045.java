...
public class Sakp045 {
		public static void pP045Proc(NNumber aidm,NNumber applSeqno,NNumber persSeqno,NNumber seqno,NString wappCode,NString procLabel,Ref<NString> errorInd) {
			
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("SAKP045.P_P045_PROC", DbManager.getDataBaseFactory());
