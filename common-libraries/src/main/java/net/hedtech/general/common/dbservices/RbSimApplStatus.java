...
public class RbSimApplStatus {
		public static NInteger fApiVersion() {
			
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("RB_SIM_APPL_STATUS.F_API_VERSION", DbManager.getDataBaseFactory());
		...
		public static NString fExists(NString pAidyCode,NNumber pPidm,NString pRowid) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("RB_SIM_APPL_STATUS.F_EXISTS", DbManager.getDataBaseFactory());
		...
		public static NString fIsequal(SimApplStatusRecRow recOne,SimApplStatusRecRow recTwo) {
			
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("RB_SIM_APPL_STATUS.F_ISEQUAL", DbManager.getDataBaseFactory());
			
			cmd.addReturnParameter(NString.class);
			cmd.addParameter(DbTypes.createStructType("REC_ONE", recOne, SimApplStatusRecRow.class ));
			cmd.addParameter(DbTypes.createStructType("REC_TWO", recTwo, SimApplStatusRecRow.class ));
		...
		public static DataCursor fQueryAll(NString pAidyCode,NNumber pPidm) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("RB_SIM_APPL_STATUS.F_QUERY_ALL", DbManager.getDataBaseFactory());
		...
		public static DataCursor fQueryByRowid(NString pRowid) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("RB_SIM_APPL_STATUS.F_QUERY_BY_ROWID", DbManager.getDataBaseFactory());
		...
		public static DataCursor fQueryOne(NString pAidyCode,NNumber pPidm) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("RB_SIM_APPL_STATUS.F_QUERY_ONE", DbManager.getDataBaseFactory());
		...
		public static DataCursor fQueryOneLock(NString pAidyCode,NNumber pPidm,NString pRowid) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("RB_SIM_APPL_STATUS.F_QUERY_ONE_LOCK", DbManager.getDataBaseFactory());
		...
		public static void pDelete(NString pAidyCode,NNumber pPidm,NString pRowid) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("RB_SIM_APPL_STATUS.P_DELETE", DbManager.getDataBaseFactory());
		...
		public static void pDeleteAll() {
			
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("RB_SIM_APPL_STATUS.P_DELETE_ALL", DbManager.getDataBaseFactory());
		...
		public static void pInsertFromRorstat(NString pAidyCode,NNumber pPidm) {
			
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("RB_SIM_APPL_STATUS.P_INSERT_FROM_RORSTAT", DbManager.getDataBaseFactory());
		...
		public static void pLock(NString pAidyCode,NNumber pPidm,Ref<NString> pRowidInout) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("RB_SIM_APPL_STATUS.P_LOCK", DbManager.getDataBaseFactory());
		...
		public static void pUpdate(NString pAidyCode,NNumber pPidm,NString pLockInd,NString pPgrpLockInd,NString pBgrpProcInd,NString pPgrpProcInd,NString pTgrpProcInd,NString pPckgFundProcInd,NString pVerComplete,NString pUserId,NString pVerPayInd,NString pBgrpCode,NString pAprdCode,NString pPgrpCode,NString pTgrpCode,NString pRecalcNaInd,NNumber pPc,NNumber pSc,NDate pApplRcvdDate,NDate pPckgFundDate,NDate pNeedDate,NDate pPckgCompDate,NDate pAllReqCompDate,NDate pMemoReqCompDate,NDate pPckgReqCompDate,NDate pDisbReqCompDate,NNumber pPellSchedAwd,NNumber pPriSarPgi,NNumber pSecSarPgi,NDate pSarDate,NString pSarTranNo,NString pSarSsn,NString pSarInit,NString pCmScLockInd,NString pCmPcLockInd,NString pCmTfcLockInd,NString pPgiLockInd,NString pInstScLockInd,NString pInstPcLockInd,NNumber pGrsNeed,NNumber pUnmetNeed,NNumber pTfc,NString pAwdLtrInd,NNumber pResourceAmt,NDate pResourceActDate,NString pTrkLtrInd,NNumber pImGrsNeed,NNumber pImUnmetNeed,NNumber pImTfc,NString pAddlStfdEligInd,NString pImLock,NString pFmBatchLock,NString pImBatchLock,NString pNsldsOvrdInd,NString pFormerHealInd,NNumber pPellLtHalfCoa,NString pInfoAccessInd,NString pBorrowerBasedCde,NString pPellOrigInd,NString pPellDisbLockInd,NString pPostBaPellOvrd,NString pInfcCode,NString pAlternatePellInd,NNumber pPellAttendCost,NNumber pLowTuitionCost,NNumber pSubLoanExclAmt,NString pTgrpCodeLockInd,NString pBgrpCodeLockInd,NString pPgrpCodeLockInd,NDate pTrkLtrIndDate,NString pTurnOffPellInd,NString pVerUserId,NDate pVerDate,NString pDataOrigin,NString pPrepOrTeachInd,NString pAcgDisbLockInd,NString pSmartDisbLockInd,NString pAutoZeroEfcInd,NString pRowid) {
			
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("RB_SIM_APPL_STATUS.P_UPDATE", DbManager.getDataBaseFactory());
	...
	@DbRecordType(id="SimApplStatusRecRow", dataSourceName="SIM_APPL_STATUS_REC")
	public static class SimApplStatusRecRow
	{
