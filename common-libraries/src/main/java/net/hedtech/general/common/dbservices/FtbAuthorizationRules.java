...
public class FtbAuthorizationRules {
		public static void pRegisterEntity(NNumber pOperationType,NString pInternalRecordId) {
			
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("FTB_AUTHORIZATION_RULES.P_REGISTER_ENTITY", DbManager.getDataBaseFactory());
		...
		public static void pRegisterEntity(NNumber pOperationType,NNumber pId,NString pDataOrigin,NDate pActivityDate,NString pUserId,NString pUserComment,NString pCompleteUser,NDate pCreateDate,NString pCreateSource,NString pCreateUser,NString pDescription,NString pDocCode,NString pEmailAddress,NString pName,NNumber pOwnerPidm,NString pRequestStatus,NDate pStatusDate,NDate pTransactionDate,NNumber pFtpbportId,NNumber pSentToTravelerBy,NDate pSentToTravelerDate,NNumber pFttvafflId,NNumber pOutstandingAdvanceAmount,NString pAdvanceStatus,NDate pAdvanceStatusDate,NString pInternalRecordId) {
		...
		public static void pValidate(NNumber pId,NString pDataOrigin,NDate pActivityDate,NString pUserId,NString pUserComment,NString pCompleteUser,NDate pCreateDate,NString pCreateSource,NString pCreateUser,NString pDescription,NString pDocCode,NString pEmailAddress,NString pName,NNumber pOwnerPidm,NString pRequestStatus,NDate pStatusDate,NDate pTransactionDate,NNumber pFtpbportId,NNumber pSentToTravelerBy,NDate pSentToTravelerDate,NNumber pFttvafflId,NNumber pOutstandingAdvanceAmount,NString pAdvanceStatus,NDate pAdvanceStatusDate) {
			
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("FTB_AUTHORIZATION_RULES.P_VALIDATE", DbManager.getDataBaseFactory());
