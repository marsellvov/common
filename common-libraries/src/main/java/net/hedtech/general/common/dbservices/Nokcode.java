...
public class Nokcode {
		public static DataCursor fCodeCv(NString tableNameIn,NString columnListIn,NString codeIn) {
			
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("NOKCODE.F_CODE_CV", DbManager.getDataBaseFactory());
		...
		public static NString fCodeDesc(NString tableNameIn,NString codeIn,NString altColumnIn) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("NOKCODE.F_CODE_DESC", DbManager.getDataBaseFactory());
		...
		public static NString fCodeExistsInd(NString tableNameIn,NString codeIn) {
			...
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("NOKCODE.F_CODE_EXISTS_IND", DbManager.getDataBaseFactory());
