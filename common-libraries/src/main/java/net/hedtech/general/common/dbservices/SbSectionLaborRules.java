...
public class SbSectionLaborRules {
		public static void pRegisterEntity(NNumber pOperationType,NString pInternalRecordId) {
			
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("SB_SECTION_LABOR_RULES.P_REGISTER_ENTITY", DbManager.getDataBaseFactory());
		...
		public static void pValidate(NString pTermCode,NString pCrn,NNumber pSeqNo,NNumber pPercent,NString pUserId,NString pDataOrigin,NString pCoasCode,NString pAcciCode,NString pFundCode,NString pOrgnCode,NString pAcctCode,NString pProgCode,NString pActvCode,NString pLocnCode,NString pProjCode,NString pCtypCode,NString pAcctExternalCde) {
			
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("SB_SECTION_LABOR_RULES.P_VALIDATE", DbManager.getDataBaseFactory());
