...
public class JavaException extends AbstractSupportCodeObject {
	

	public JavaException(ISupportCodeContainer container) {
		super(container);
	}
	...
	//Original PL/SQL code for Package Prog Unit (SPEC) JAVA_EXCEPTION
	/*
	PACKAGE JAVA_EXCEPTION <multilinecomment> java.lang.Exception </multilinecomment> IS
...
END;
	*/
		...
		//Original PL/SQL code for Package Prog Unit (BODY) JAVA_EXCEPTION
		/*
...
//
//
			this.getLogger().trace(this, "F2J : JavaException Constructor is not completely migrated yet. Please read the Migration Guide.");
