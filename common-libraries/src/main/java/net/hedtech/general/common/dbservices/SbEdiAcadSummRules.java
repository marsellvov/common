...
public class SbEdiAcadSummRules {
		public static void pRegisterEntity(NNumber pOperationType,NString pInternalRecordId) {
			
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("SB_EDI_ACAD_SUMM_RULES.P_REGISTER_ENTITY", DbManager.getDataBaseFactory());
		...
		public static void pRegisterEntity(NNumber pOperationType,NNumber pDcmtSeqno,NNumber pGpaSeqno,NString pCtypCode,NString pSlvlCode,NNumber pGpaHours,NNumber pHoursAttempted,NNumber pHoursEarned,NNumber pGpaLow,NNumber pGpaHigh,NNumber pGpa,NString pGpaExcessInd,NNumber pClassRank,NNumber pClassSize,NString pRdqlCode,NString pRankDate,NString pDataOrigin,NString pUserId,NString pInternalRecordId) {
		...
		public static void pValidate(NNumber pDcmtSeqno,NNumber pGpaSeqno,NString pCtypCode,NString pSlvlCode,NNumber pGpaHours,NNumber pHoursAttempted,NNumber pHoursEarned,NNumber pGpaLow,NNumber pGpaHigh,NNumber pGpa,NString pGpaExcessInd,NNumber pClassRank,NNumber pClassSize,NString pRdqlCode,NString pRankDate,NString pDataOrigin,NString pUserId) {
			
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("SB_EDI_ACAD_SUMM_RULES.P_VALIDATE", DbManager.getDataBaseFactory());
