...
public class GOptBlockController extends AbstractSupportCodeObject {
	...
	private net.hedtech.general.common.libraries.Goqolib.controller.GOptBlockController getGoqolibGOptBlockController() {
		return (net.hedtech.general.common.libraries.Goqolib.controller.GOptBlockController) this.getContainer().getTaskPart("GOQOLIB").getSupportCodeManager().getPackage("G$_OPT_BLOCK");
	}	
