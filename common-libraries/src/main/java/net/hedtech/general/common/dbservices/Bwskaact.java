...
public class Bwskaact {
		public static void pDispappactivities(NNumber appno,NString wsct) {
			
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("BWSKAACT.P_DISPAPPACTIVITIES", DbManager.getDataBaseFactory());
...
//		public static void pProcappactivities(NNumber appno,NString wsct,List<Bwskalog.Varchar2TabtypeRow> actv,NString actvReq,NString descsReq,List<Bwskalog.Varchar2TabtypeRow> seqnos,List<Varchar2132TabtypeRow> descs,NString submitBtn,NString ud1,NString ud2,NString ud3,NString ud4,NString ud5,NString ud6,NString ud7,NString ud8,NString ud9,NString ud10,NString ud1Seqno,NString ud2Seqno,NString ud3Seqno,NString ud4Seqno,NString ud5Seqno,NString ud6Seqno,NString ud7Seqno,NString ud8Seqno,NString ud9Seqno,NString ud10Seqno,NString ud1Req,NString ud2Req,NString ud3Req,NString ud4Req,NString ud5Req,NString ud6Req,NString ud7Req,NString ud8Req,NString ud9Req,NString ud10Req,NString inothers) {
//			
//			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("BWSKAACT.P_PROCAPPACTIVITIES", DbManager.getDataBaseFactory());
//			
//			cmd.addParameter("@APPNO", appno);
//			cmd.addParameter("@WSCT", wsct);
//			// cmd.addParameter(DbTypes.getTableType("ACTV", "", actv, object.class));
//			cmd.addParameter("@ACTV_REQ", actvReq);
//			cmd.addParameter("@DESCS_REQ", descsReq);
//			// cmd.addParameter(DbTypes.getTableType("SEQNOS", "", seqnos, object.class));
//			// cmd.addParameter(DbTypes.getTableType("DESCS", "", descs, object.class));
...
//			cmd.addParameter("@INOTHERS", inothers);
//				
//			cmd.execute();
//
//
