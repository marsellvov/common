...
public class PbDeductionBaseStrings {
		public static NString fGetError(NString pErrorname,NString pValue01,NString pValue02,NString pValue03) {
			
			IDataCommand cmd = DbManager.getDataAccessFactory().createDataCommand("PB_DEDUCTION_BASE_STRINGS.F_GET_ERROR", DbManager.getDataBaseFactory());
