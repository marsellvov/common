package net.hedtech.banner.finance.common.Foqsdlv.services;
...
public class FoqsdlvServices extends AbstractSupportCodeObject{
	
	
	public FoqsdlvServices(ISupportCodeContainer container) {
		super(container);
	}
	
	public FoqsdlvTask  getTask() {
		return (FoqsdlvTask )super.getContainer();
	}

	
	public net.hedtech.banner.finance.common.Foqsdlv.model.FoqsdlvModel getFormModel() {
...
<multilinecomment>
AUDIT TRAIL: 4.0
  1. ENHANCEMENT...Phase II UI Changes
   SIGNOFF....S Mukhortov          26-JAN-1999
   Atached GOQWFLW library and modified KEY-EXIT AND KEY-NEXTKEY triggers and renamed them to
   KEY_EXIT_TRG and KEY_NEXTKEY_TRG. Also changed the item width on fields that have less then
   6 characters.
