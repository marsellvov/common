package net.hedtech.banner.finance.common.Ftvfund;
...
/// 
/// </summary>
public class FtvfundTask extends BaseTask
{
	public FtvfundTask (String taskName) {
		super(taskName);
	}

	public FtvfundTask (String taskName, Hashtable sharedLibraries, Hashtable parameters) {
		super(taskName, sharedLibraries, parameters);
	}

	@Override
	public net.hedtech.banner.finance.common.Ftvfund.model.FtvfundModel getModel() {
		return (net.hedtech.banner.finance.common.Ftvfund.model.FtvfundModel)super.getModel();
	}

	public net.hedtech.banner.finance.common.Ftvfund.services.FtvfundServices getServices() {
		return (net.hedtech.banner.finance.common.Ftvfund.services.FtvfundServices)getSupportCodeManager().getServices();
	}
