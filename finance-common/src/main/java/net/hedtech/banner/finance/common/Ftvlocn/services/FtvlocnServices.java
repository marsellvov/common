package net.hedtech.banner.finance.common.Ftvlocn.services;
...
public class FtvlocnServices extends AbstractSupportCodeObject{
	
	
	public FtvlocnServices(ISupportCodeContainer container) {
		super(container);
	}
	
	public FtvlocnTask  getTask() {
		return (FtvlocnTask )super.getContainer();
	}

	
	public net.hedtech.banner.finance.common.Ftvlocn.model.FtvlocnModel getFormModel() {
