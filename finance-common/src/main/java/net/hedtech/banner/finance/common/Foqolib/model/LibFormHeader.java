...
public class LibFormHeader extends SimpleBusinessObject
{
	public LibFormHeader() {
		super();
	}

	public LibFormHeader(SimpleBusinessObjectConfiguration configuration, String name) {
