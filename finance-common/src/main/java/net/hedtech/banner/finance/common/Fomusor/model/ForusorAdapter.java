...
public class ForusorAdapter extends BaseRowAdapter{
	

	public ForusorAdapter(DataRow row, IDBBusinessObject businessObject) {
	...
	public void setOrgnTitle(NString value){
		this.setValue("ORGN_TITLE", value.getValue());
	}


	public NString getOrgnTitle(){
		NString v = new NString((String)this.getValue("ORGN_TITLE"));
		return v;
	}
	...
	public void setAccessInd(NString value){
		this.setValue("ACCESS_IND", value.getValue());
	}


	public NString getAccessInd(){
		NString v = new NString((String)this.getValue("ACCESS_IND"));
		return v;
	}
