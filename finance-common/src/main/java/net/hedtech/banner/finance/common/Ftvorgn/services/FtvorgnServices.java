package net.hedtech.banner.finance.common.Ftvorgn.services;
...
public class FtvorgnServices extends AbstractSupportCodeObject{
	
	
	public FtvorgnServices(ISupportCodeContainer container) {
		super(container);
	}
	
	public FtvorgnTask  getTask() {
		return (FtvorgnTask )super.getContainer();
	}

	
	public net.hedtech.banner.finance.common.Ftvorgn.model.FtvorgnModel getFormModel() {
...
<multilinecomment>AUDIT TRAIL: 3.1
  ...
  fix.......Created trigger KEY-EXEQRY on FTVORGN blk 
...
1. Christine Liu     08/12/98
   ...
   for more details.
2. William Bishop     01/23/99
   Phase II UI Changes.  
3. defect......none
   signoff.....Wei Zhang 02/05/99
   problem.....data is allowed to be inserted in the 'insert not allowed field'
   fix.........Changing 'insert allowed' property to 'insert not allowed' for ftvorgn block.
