...
public class Block3Controller extends DefaultBlockController {
	...
	public Block3Controller(IFormController parentController, String name) 
	{
	...
	//action methods generated from triggers
		 ...
		 * AGENCY_NAME_1.KEY-NEXT-ITEM
		 *
		 *
		 *</p>
		*/

		@ActionTrigger(action="KEY-NEXT-ITEM", item="AGENCY_NAME_1", function=KeyFunction.NEXT_ITEM)
		public void agencyName1_keyNexItem()
		{
