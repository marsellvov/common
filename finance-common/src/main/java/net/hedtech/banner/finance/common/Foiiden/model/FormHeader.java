package net.hedtech.banner.finance.common.Foiiden.model;
...
public class FormHeader extends SimpleBusinessObject
{
	...
	public NString getDispQueryStatus() {
		return toStr(super.getValue("DISP_QUERY_STATUS"));
	}
	
	public void setDispQueryStatus(NString value) {
		super.setValue("DISP_QUERY_STATUS", value);
	}
