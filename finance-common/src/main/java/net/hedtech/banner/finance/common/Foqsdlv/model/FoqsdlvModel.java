...
public class FoqsdlvModel extends FormModel {
	
	
	public FoqsdlvModel(ITask task, Hashtable parameters){
	...
	public IDBBusinessObject getFtvsdat() 
	{
		return (IDBBusinessObject) getBusinessObject("FTVSDAT");
	}
