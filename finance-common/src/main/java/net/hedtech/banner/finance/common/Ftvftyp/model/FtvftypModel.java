...
public class FtvftypModel extends FormModel {
	
	
	public FtvftypModel(ITask task, Hashtable parameters){
	...
	public IDBBusinessObject getFtvftyp() 
	{
		return (IDBBusinessObject) getBusinessObject("FTVFTYP");
	}
