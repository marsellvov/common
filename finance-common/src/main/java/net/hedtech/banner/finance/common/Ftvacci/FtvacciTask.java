package net.hedtech.banner.finance.common.Ftvacci;
...
/// 
/// </summary>
public class FtvacciTask extends BaseTask
{
	public FtvacciTask (String taskName) {
		super(taskName);
	}

	public FtvacciTask (String taskName, Hashtable sharedLibraries, Hashtable parameters) {
		super(taskName, sharedLibraries, parameters);
	}

	@Override
	public net.hedtech.banner.finance.common.Ftvacci.model.FtvacciModel getModel() {
		return (net.hedtech.banner.finance.common.Ftvacci.model.FtvacciModel)super.getModel();
	}

	public net.hedtech.banner.finance.common.Ftvacci.services.FtvacciServices getServices() {
		return (net.hedtech.banner.finance.common.Ftvacci.services.FtvacciServices)getSupportCodeManager().getServices();
	}
