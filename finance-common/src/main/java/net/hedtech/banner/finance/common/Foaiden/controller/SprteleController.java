	...
	//action methods generated from triggers
		...
		*/
		...
		public void sprteleTeleCode_doubleClick()
		{
				...
				getGoqclibSprteleController().sprteleTeleCode_WhenMouseDoubleclick();
			}
		...
		*/
		...
		public void sprteleTeleCode_validate()
		{
			...
			getGoqclibSprteleController().sprteleTeleCode_validate();
			}
		...
		*/
		...
		{
			getGoqclibSprteleController().sprtele_AfterQuery(args);
...
//			this.sprteleTeleCode_PostChange();
		...
		*/
		...
		{
			getGoqclibSprteleController().sprteleAtypCode_validate();
