...
public class FtvcoasModel extends FormModel {
	
	
	public FtvcoasModel(ITask task, Hashtable parameters){
	...
	public IDBBusinessObject getFtvcoas() 
	{
		return (IDBBusinessObject) getBusinessObject("FTVCOAS");
	}
/*
