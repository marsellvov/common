...
public class FormHeader extends SimpleBusinessObject
{
	...
	public NString getHoldCode() {
		return toStr(super.getValue("HOLD_CODE"));
	}
	
	public void setHoldCode(NString value) {
		super.setValue("HOLD_CODE", value);
	}
	...
	public NString getUpdCode() {
		return toStr(super.getValue("UPD_CODE"));
	}
	
	public void setUpdCode(NString value) {
		super.setValue("UPD_CODE", value);
	}
