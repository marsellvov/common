...
public class FtvfundModel extends FormModel {
	
	
	public FtvfundModel(ITask task, Hashtable parameters){
	...
	public IDBBusinessObject getFtvfund() 
	{
		return (IDBBusinessObject) getBusinessObject("FTVFUND");
	}
