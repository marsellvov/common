package net.hedtech.banner.finance.common.Ftvorgn;
...
/// 
/// </summary>
public class FtvorgnTask extends BaseTask
{
	public FtvorgnTask (String taskName) {
		super(taskName);
	}

	public FtvorgnTask (String taskName, Hashtable sharedLibraries, Hashtable parameters) {
		super(taskName, sharedLibraries, parameters);
	}

	@Override
	public net.hedtech.banner.finance.common.Ftvorgn.model.FtvorgnModel getModel() {
		return (net.hedtech.banner.finance.common.Ftvorgn.model.FtvorgnModel)super.getModel();
	}

	public net.hedtech.banner.finance.common.Ftvorgn.services.FtvorgnServices getServices() {
		return (net.hedtech.banner.finance.common.Ftvorgn.services.FtvorgnServices)getSupportCodeManager().getServices();
	}
