package net.hedtech.banner.finance.common.Ftvftyp.services;
...
public class FtvftypServices extends AbstractSupportCodeObject{
	
	
	public FtvftypServices(ISupportCodeContainer container) {
		super(container);
	}
	
	public FtvftypTask  getTask() {
		return (FtvftypTask )super.getContainer();
	}

	
	public net.hedtech.banner.finance.common.Ftvftyp.model.FtvftypModel getFormModel() {
...
2. defect......none
   ...
   fix.........Changing 'insert allowed' property to 'insert not allowed' for ftvfryp block.
AUDIT TRAIL END
</multilinecomment>
BEGIN
  NULL;
...
<multilinecomment>
AUDIT TRAIL: 4.0
1.Phase II UI Changes.  Tatyana Ispas 01/25/99
AUDIT TRAIL END
</multilinecomment>
BEGIN
  NULL;
...
<multilinecomment> 
AUDIT TRAIL: 8.0  
1.Grants Management Enhancement Multiple Year Encumbering             KS 05/28/2007 
   A new checkbox field is added Encumber Multi Year Labor (FTVFTYP_ENC_MULT_YR_IND). 
