package net.hedtech.banner.finance.common.Ftvobud.services;
...
public class FtvobudServices extends AbstractSupportCodeObject{
	
	
	public FtvobudServices(ISupportCodeContainer container) {
		super(container);
	}
	
	public FtvobudTask  getTask() {
		return (FtvobudTask )super.getContainer();
	}

	
	public net.hedtech.banner.finance.common.Ftvobud.model.FtvobudModel getFormModel() {
...
2. William Bishop 01/24/99
   Phase II UI Changes.
3. defect......none
   signoff.....Wei Zhang 02/05/99
   problem.....data is allowed to be inserted in the 'insert not allowed field'
   fix.........Changing 'insert allowed' property to 'insert not allowed' for ftvobud block.
