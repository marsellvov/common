package net.hedtech.banner.finance.common.Ftvprog.services;
...
public class FtvprogServices extends AbstractSupportCodeObject{
	
	
	public FtvprogServices(ISupportCodeContainer container) {
		super(container);
	}
	
	public FtvprogTask  getTask() {
		return (FtvprogTask )super.getContainer();
	}

	
	public net.hedtech.banner.finance.common.Ftvprog.model.FtvprogModel getFormModel() {
...
<multilinecomment>AUDIT TRAIL: 3.1
  ...
  fix.......Created trigger KEY-EXEQRY on FTVPROG blk 
...
3. defect......none
   ...
   fix.........Changing 'insert allowed' property to 'insert not allowed' for ftvprog block.
