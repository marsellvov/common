...
public class FtmeclsModel extends FormModel {
	
	
	public FtmeclsModel(ITask task, Hashtable parameters){
	...
	public IDBBusinessObject getFtvecls() 
	{
		return (IDBBusinessObject) getBusinessObject("FTVECLS");
	}
