package net.hedtech.banner.finance.common.Ftvftyp;
...
/// 
/// </summary>
public class FtvftypTask extends BaseTask
{
	public FtvftypTask (String taskName) {
		super(taskName);
	}

	public FtvftypTask (String taskName, Hashtable sharedLibraries, Hashtable parameters) {
		super(taskName, sharedLibraries, parameters);
	}

	@Override
	public net.hedtech.banner.finance.common.Ftvftyp.model.FtvftypModel getModel() {
		return (net.hedtech.banner.finance.common.Ftvftyp.model.FtvftypModel)super.getModel();
	}

	public net.hedtech.banner.finance.common.Ftvftyp.services.FtvftypServices getServices() {
		return (net.hedtech.banner.finance.common.Ftvftyp.services.FtvftypServices)getSupportCodeManager().getServices();
	}
