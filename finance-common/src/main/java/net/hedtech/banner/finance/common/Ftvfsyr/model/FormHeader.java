...
public class FormHeader extends SimpleBusinessObject
{
	...
	public NString getHoldCurrentPeriod() {
		return toStr(super.getValue("HOLD_CURRENT_PERIOD"));
	}
	
	public void setHoldCurrentPeriod(NString value) {
		super.setValue("HOLD_CURRENT_PERIOD", value);
	}
	


	public NString getHoldEarliestOpenPeriod() {
		return toStr(super.getValue("HOLD_EARLIEST_OPEN_PERIOD"));
	}
	
	public void setHoldEarliestOpenPeriod(NString value) {
		super.setValue("HOLD_EARLIEST_OPEN_PERIOD", value);
	}
