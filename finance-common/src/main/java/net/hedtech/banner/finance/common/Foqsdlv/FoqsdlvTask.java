package net.hedtech.banner.finance.common.Foqsdlv;
...
/// 
/// </summary>
public class FoqsdlvTask extends BaseTask
{
	public FoqsdlvTask (String taskName) {
		super(taskName);
	}

	public FoqsdlvTask (String taskName, Hashtable sharedLibraries, Hashtable parameters) {
		super(taskName, sharedLibraries, parameters);
	}

	@Override
	public net.hedtech.banner.finance.common.Foqsdlv.model.FoqsdlvModel getModel() {
		return (net.hedtech.banner.finance.common.Foqsdlv.model.FoqsdlvModel)super.getModel();
	}

	public net.hedtech.banner.finance.common.Foqsdlv.services.FoqsdlvServices getServices() {
		return (net.hedtech.banner.finance.common.Foqsdlv.services.FoqsdlvServices)getSupportCodeManager().getServices();
	}
