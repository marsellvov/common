package net.hedtech.banner.finance.common.Ftvactv.services;
...
public class FtvactvServices extends AbstractSupportCodeObject{
	
	
	public FtvactvServices(ISupportCodeContainer container) {
		super(container);
	}
	
	public FtvactvTask  getTask() {
		return (FtvactvTask )super.getContainer();
	}

	
	public net.hedtech.banner.finance.common.Ftvactv.model.FtvactvModel getFormModel() {
