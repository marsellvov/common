package net.hedtech.banner.finance.common.Frikgnt;
...
/// 
/// </summary>
public class FrikgntTask extends BaseTask
{
	public FrikgntTask (String taskName) {
		super(taskName);
	}

	public FrikgntTask (String taskName, Hashtable sharedLibraries, Hashtable parameters) {
		super(taskName, sharedLibraries, parameters);
	}

	@Override
	public net.hedtech.banner.finance.common.Frikgnt.model.FrikgntModel getModel() {
		return (net.hedtech.banner.finance.common.Frikgnt.model.FrikgntModel)super.getModel();
	}

	public net.hedtech.banner.finance.common.Frikgnt.services.FrikgntServices getServices() {
		return (net.hedtech.banner.finance.common.Frikgnt.services.FrikgntServices)getSupportCodeManager().getServices();
	}
