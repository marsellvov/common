...
public class FtvcoasServices extends AbstractSupportCodeObject{
	
	
	public FtvcoasServices(ISupportCodeContainer container) {
		super(container);
	}
	
	public FtvcoasTask  getTask() {
		return (FtvcoasTask )super.getContainer();
	}

	
	public net.hedtech.banner.finance.common.Ftvcoas.model.FtvcoasModel getFormModel() {
