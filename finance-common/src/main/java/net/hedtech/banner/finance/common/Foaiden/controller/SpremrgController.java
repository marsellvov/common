	...
	//action methods generated from triggers
		...
		*/
		...
		public void spremrgReltCode_doubleClick()
		{
				...
				getGoqclibSpremrgController().spremrgReltCode_WhenMouseDoubleclick();
			}
		...
		*/
		...
		public void spremrgAtypCode_doubleClick()
		{
				...
				getGoqclibSpremrgController().spremrgAtypCode_WhenMouseDoubleclick();
			}
		...
		*/
		...
		public void spremrgStatCode_doubleClick()
		{
				...
				getGoqclibSpremrgController().spremrgStatCode_WhenMouseDoubleclick();
			}
		...
		*/
		...
		public void spremrgZip_doubleClick()
		{
				...
				getGoqclibSpremrgController().spremrgZip_WhenMouseDoubleclick();
			}
		...
		*/
		...
		public void spremrgNatnCode_doubleClick()
		{
				...
				getGoqclibSpremrgController().spremrgNatnCode_WhenMouseDoubleclick();
			}
		...
		*/
		...
		/* Original PL/SQL code code for TRIGGER SPREMRG_NATN_CODE.KEY-NEXT-ITEM
		 BEGIN
...
END;
		...
		*/
		...
		{
			getGoqclibSpremrgController().spremrgReltCode_validate();
...
//							this.spremrgReltCode_PostChange();
		...
		*/
		...
		{
			getGoqclibSpremrgController().spremrg_AfterQuery(args);
...
//			this.spremrgReltCode_PostChange();
		...
		*/
		...
		{
			getGoqclibSpremrgController().spremrgAtypCode_validate();
//				SpremrgAdapter spremrgElement = (SpremrgAdapter)this.getFormModel().getSpremrg().getRowAdapter(true);
//							this.spremrgAtypCode_PostChange();
		...
		*/
		...
		{
			getGoqclibSpremrgController().spremrgStatCode_validate();
//				SpremrgAdapter spremrgElement = (SpremrgAdapter)this.getFormModel().getSpremrg().getRowAdapter(true);
//							this.spremrgStatCode_PostChange();
		...
		*/
		...
		{
			getGoqclibSpremrgController().spremrgNatnCode_validate();
//				SpremrgAdapter spremrgElement = (SpremrgAdapter)this.getFormModel().getSpremrg().getRowAdapter(true);
