...
import net.hedtech.banner.finance.common.Frikgnt.model.ButtonControlBlock;





public class FrikgntModel extends FormModel {
	
	
	public FrikgntModel(ITask task, Hashtable parameters){
