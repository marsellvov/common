...
public class FtvprojModel extends FormModel {
	
	
	public FtvprojModel(ITask task, Hashtable parameters){
	...
	public IDBBusinessObject getFtvproj() 
	{
		return (IDBBusinessObject) getBusinessObject("FTVPROJ");
	}
