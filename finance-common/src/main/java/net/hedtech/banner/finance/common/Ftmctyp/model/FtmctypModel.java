...
public class FtmctypModel extends FormModel {
	
	
	public FtmctypModel(ITask task, Hashtable parameters){
	...
	public IDBBusinessObject getFtvctyp() 
	{
		return (IDBBusinessObject) getBusinessObject("FTVCTYP");
	}
