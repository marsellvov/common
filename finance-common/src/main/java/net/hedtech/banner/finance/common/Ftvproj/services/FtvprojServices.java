...
public class FtvprojServices extends AbstractSupportCodeObject{
	
	
	public FtvprojServices(ISupportCodeContainer container) {
		super(container);
	}
	
	public FtvprojTask  getTask() {
		return (FtvprojTask )super.getContainer();
	}

	
	public net.hedtech.banner.finance.common.Ftvproj.model.FtvprojModel getFormModel() {
...
1. Robert Rullo 10/19/98
   ...
   for more details.
2. Raji Ramasubramoni 01/25/1999
   U/I Phase II changes
3. defect......none
   signoff.....Wei Zhang 02/05/99
   problem.....data is allowed to be inserted in the 'insert not allowed field'
   fix.........Changing 'insert allowed' property to 'insert not allowed' for ftvproj block.
