...
public class FoaidenModel extends FormModel {
	
	
	public FoaidenModel(ITask task, Hashtable parameters){
	...
	public Soaappt getSoaappt() 
	{
		return (Soaappt) getBusinessObject("SOAAPPT");
	}

	public Guasyst getGuasyst() 
	{
		return (Guasyst) getBusinessObject("GUASYST");
	}
