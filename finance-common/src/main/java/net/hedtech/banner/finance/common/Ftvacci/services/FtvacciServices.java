package net.hedtech.banner.finance.common.Ftvacci.services;
...
public class FtvacciServices extends AbstractSupportCodeObject{
	
	
	public FtvacciServices(ISupportCodeContainer container) {
		super(container);
	}
	
	public FtvacciTask  getTask() {
		return (FtvacciTask )super.getContainer();
	}

	
	public net.hedtech.banner.finance.common.Ftvacci.model.FtvacciModel getFormModel() {
