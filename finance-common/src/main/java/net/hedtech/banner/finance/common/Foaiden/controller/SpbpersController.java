	...
	//action methods generated from triggers
		...
		*/
		...
		public void spbpersCitzCode_doubleClick()
		{
				...
				getGoqclibSpbpersController().spbpersCitzCode_WhenMouseDoubleclick();
			}
		...
		*/
		...
		public void spbpersMrtlCode_doubleClick()
		{
				...
				getGoqclibSpbpersController().spbpersMrtlCode_WhenMouseDoubleclick();
			}
		...
		*/
		...
		public void spbpersRelgCode_doubleClick()
		{
				...
				getGoqclibSpbpersController().spbpersRelgCode_WhenMouseDoubleclick();
			}
		...
		*/
		...
		public void spbpersLgcyCode_doubleClick()
		{
				...
				getGoqclibSpbpersController().spbpersLgcyCode_WhenMouseDoubleclick();
			}
		...
		*/
		...
		public void spbpersEthnCode_doubleClick()
		{
				...
				getGoqclibSpbpersController().spbpersEthnCode_WhenMouseDoubleclick();
			}
		...
		*/
		...
		{
			getGoqclibSpbpersController().spbpersSsn_validate();
...
//							this.spbpersSsn_PostChange();
		...
		*/
		...
		{
			getGoqclibSpbpersController().spbpersConfirmedReDate_validate();
//				SpbpersAdapter spbpersElement = (SpbpersAdapter)this.getFormModel().getSpbpers().getRowAdapter(true);
