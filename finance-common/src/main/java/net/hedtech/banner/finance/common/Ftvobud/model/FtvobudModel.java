...
public class FtvobudModel extends FormModel {
	
	
	public FtvobudModel(ITask task, Hashtable parameters){
	...
	public IDBBusinessObject getFtvobud() 
	{
		return (IDBBusinessObject) getBusinessObject("FTVOBUD");
	}
