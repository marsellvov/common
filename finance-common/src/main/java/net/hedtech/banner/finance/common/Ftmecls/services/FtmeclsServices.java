...
public class FtmeclsServices extends AbstractSupportCodeObject{
	
	
	public FtmeclsServices(ISupportCodeContainer container) {
		super(container);
	}
	
	public FtmeclsTask  getTask() {
		return (FtmeclsTask )super.getContainer();
	}

	
	public net.hedtech.banner.finance.common.Ftmecls.model.FtmeclsModel getFormModel() {
...
2. Srilakshmi Baisetty    26-JAN-1999
   Phase II UI Changes.
