...
public class FtvlocnModel extends FormModel {
	
	
	public FtvlocnModel(ITask task, Hashtable parameters){
	...
	public IDBBusinessObject getFtvlocn() 
	{
		return (IDBBusinessObject) getBusinessObject("FTVLOCN");
	}
