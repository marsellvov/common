...
public class SpraddrController extends DefaultBlockController {
	...
	//action methods generated from triggers
		...
		*/
		...
		//TODO MORPHIS
				@ActionTrigger(action="KEY-NEXT-ITEM", item="PHONE_EXT", function=KeyFunction.NEXT_ITEM)
				public void phoneExt_keyNexItem()
				{
					
//					getGoqclibSpraddrController().spraddrAsrcCode_keyNexItem();
					goItem("SPRADDR_STATUS_IND");
				}
				
		
				
		//TODO MORPHIS	
				@ActionTrigger(action="KEY-PREV-ITEM", item="SPRADDR_STATUS_IND", function=KeyFunction.PREVIOUS_ITEM)
				public void spraddrStatusInd_PreviousItem()
				{
					goItem("PHONE_EXT");
//					getGoqclibSpraddrController().spraddrZip_PreviousItem();
		...
		// Francisco Carvalho - Codigo adicionado para efectuar a navegação dos items como no original 
