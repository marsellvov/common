...
public class AptaddrHeaderController extends DefaultBlockController {
	...
	public AptaddrHeaderController(IFormController parentController, String name) 
	{
	...
	//action methods generated from triggers
		 ...
		 * ADDR_NAME_LF30.KEY-NEXT-ITEM
		 *
		 *
		 *</p>
		*/

		@ActionTrigger(action="KEY-NEXT-ITEM", item="ADDR_NAME_LF30", function=KeyFunction.NEXT_ITEM)
		public void addrNameLf30_keyNexItem()
		{
