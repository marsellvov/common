...
public class KeyBlock extends SimpleBusinessObject
{
	...
	public NNumber getPreferredRecordNumber() {
		return toNumber(super.getValue("PREFERRED_RECORD_NUMBER"));
	}
	
	public void setPreferredRecordNumber(NNumber value) {
		super.setValue("PREFERRED_RECORD_NUMBER", value);
	}
	...
	public NNumber getAtypCount() {
		return toNumber(super.getValue("ATYP_COUNT"));
	}
	
	public void setAtypCount(NNumber value) {
		super.setValue("ATYP_COUNT", value);
	}
	


	public NString getManualCmCall() {
		return toStr(super.getValue("MANUAL_CM_CALL"));
	}
	
	public void setManualCmCall(NString value) {
		super.setValue("MANUAL_CM_CALL", value);
	}
