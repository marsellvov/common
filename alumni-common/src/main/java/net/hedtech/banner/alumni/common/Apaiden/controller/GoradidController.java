...
public class GoradidController extends DefaultBlockController {
	...
	//action methods generated from triggers
		...
		*/
		...
		{
			//MORPHIS TODO MP funcionalidade comentada, uma vez que estava a provocar comportamentos irregulares com o executequery (disparava 2x o itemout)
			
			//getGoqclibGoradidController().goradidAdidCode_itemOut();
		}
