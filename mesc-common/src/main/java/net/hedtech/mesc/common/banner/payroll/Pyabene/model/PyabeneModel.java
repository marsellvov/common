...
public class PyabeneModel extends FormModel {
	
	
	public PyabeneModel(ITask task, Hashtable parameters){
	...
	public IDBBusinessObject getPdrbene() 
	{
		return (IDBBusinessObject) getBusinessObject("PDRBENE");
	}
